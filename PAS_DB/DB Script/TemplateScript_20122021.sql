...
<body>
	<form id="" name="" action=" #" method="post" onsubmit="return false;">
		...
		<div class="col-md-12 form-group  display-flex">
			<div class="col-md-6">
				<div class="col-md-12 form-group" style="height:50px;width:380px;##Maginset## margin-left: 400px;">
			...
			<div class="col-md-6">
				<div class="form-check">
					<div style="margin-top: -5px">
						<input class="form-check-input" type="checkbox" value="" id="istheIDPlatemissing" ##1Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="istheIDPlatemissing" ##1No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="istheIDPlatemissing" ##1NA##> </div>
				...
				<div class="form-check">
					<div style="margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="SerialNum" ##2Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="SerialNum" ##2No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="SerialNum" ##2NA##> </div>
					<div style="margin-top: -22px;margin-left: 100px">
				...
				<div class="form-check">
					<div style="margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="COND" ##3Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="COND" ##3No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="COND" ##3NA##> </div>
					<div style="margin-top: -22px;margin-left: 100px">
				...
				<div class="form-check">
					<div style="margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="Qty" ##4Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="Qty" ##4No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="Qty" ##4NA##> </div>
					<div style="margin-top: -22px;margin-left: 100px">
				...
				<div class="form-check">
					<div style="margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="ShelfLife" ##5Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="ShelfLife" ##5No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="ShelfLife" ##5NA##> </div>
					<div style="margin-top: -22px;margin-left: 100px">
				...
				<div class="form-check">
					<div style="margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="LotBatchNum" ##6Yes##> </div>
					<div style="margin-top: -26px;margin-left: 35px">
						<input class="form-check-input" type="checkbox" value="" id="LotBatchNum" ##6No##> </div>
					<div style="margin-top: -26px;margin-left: 70px">
						<input class="form-check-input" type="checkbox" value="" id="LotBatchNum" ##6NA##> </div>
					<div style="margin-top: -22px;margin-left: 100px">
			...
			<div class="col-md-6">
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: -135px">
						<input class="form-check-input" type="checkbox" value="" id="GeneralVisualInspection" ##7Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="GeneralVisualInspection" ##7No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="GeneralVisualInspection" ##7NA##> </div>
				...
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="AppropriatePackaging" ##8Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="AppropriatePackaging" ##8No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="AppropriatePackaging" ##8NA##> </div>
					<div style="margin-left: 440px;width:380px;margin-top: -22px;">
				...
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="ESDCapsandPackaging" ##9Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="ESDCapsandPackaging" ##9No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="ESDCapsandPackaging" ##9NA##> </div>
					<div style="margin-left: 440px;width:380px;margin-top: -22px;">
				...
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="HazardousMaterial" ##10Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="HazardousMaterial" ##10No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="HazardousMaterial" ##10NA##> </div>
					<div style="margin-left: 440px;width:380px;margin-top: -22px;">
				...
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="MeetsPORequirements" ##11Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="MeetsPORequirements" ##11No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="MeetsPORequirements" ##11NA##> </div>
					<div style="margin-left: 440px;width:380px;margin-top: -22px;">
				...
				<div class="form-check">
					<div style="margin-left: 340px;margin-top: 1px">
						<input class="form-check-input" type="checkbox" value="" id="CompletePaperwork" ##12Yes##> </div>
					<div style="margin-left: 375px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="CompletePaperwork" ##12No##> </div>
					<div style="margin-left: 410px;margin-top: -26px">
						<input class="form-check-input" type="checkbox" value="" id="CompletePaperwork" ##12NA##> </div>
					<div style="margin-left: 440px;width:380px;margin-top: -22px;">
