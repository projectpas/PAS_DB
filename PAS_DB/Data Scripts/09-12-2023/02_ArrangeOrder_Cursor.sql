...
BEGIN   	  	   	 
	 ...
	 SELECT [FieldMasterId],[FieldSortOrder],[FieldName] FROM [dbo].[FieldMaster] WHERE MasterCompanyId = @MasterCompanyId AND ModuleId = (SELECT GridModuleId FROM GridModule WHERE ModuleName = 'PurchaseOrderHistory') ORDER BY [FieldSortOrder] ASC
