...
BEGIN
	...
	SET NOCOUNT ON;
	BEGIN TRY
		select DISTINCT po.PurchaseOrderId,po.PurchaseOrderNumber,pop.PartNumber,pop.PartDescription,pop.PurchaseOrderPartRecordId,po.CreatedDate from PurchaseOrder po WITH(NOLOCK)
