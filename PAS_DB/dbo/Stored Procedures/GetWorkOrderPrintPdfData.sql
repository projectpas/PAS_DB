		...
		BEGIN TRANSACTION
			BEGIN  
				...
				FROM Dbo.WorkOrder wo WITH(NOLOCK)
					...
					LEFT join Dbo.WorkOrderWorkFlow wf WITH(NOLOCK) on wf.WorkOrderId = wop.WorkOrderId and wf.WorkOrderPartNoId=wop.id
					...
					LEFT JOIN Dbo.ReceivingCustomerWork rc WITH(NOLOCK) on rc.StockLineId = sl.StockLineId
