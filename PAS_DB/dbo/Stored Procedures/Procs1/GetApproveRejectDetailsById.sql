/*************************************************************           
 ** File:   [GetApproveRejectDetailsById]           
 ** Author:  AMIT GHEDIYA
 ** Description: This stored procedure is used to Get GetDelete ApproveReject data ById
 ** Purpose:         
 ** Date:   22/08/2025      
 ...
 ** --   --------     -------		--------------------------------          
    1    22/08/2025   AMIT GHEDIYA      Created
	2    10/03/2026   Bhargav Saliya    [PN-15717]Added MasterCompanyId in where clause

-- EXEC GetApproveRejectDetailsById 769,5898,1
************************************************************************/
CREATE     PROCEDURE [dbo].[GetApproveRejectDetailsById]
	@RefrenceId BIGINT,
...
BEGIN
	...
	BEGIN
		  ...
		  AND SubRefrenceId = @SubRefrenceId
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
        , @AdhocComments     VARCHAR(150)    = 'GetApproveRejectDetailsById' 
