/***************************************************************  
 ** File:   [GetWorkOrderTaskDetailsById]             
 ** Author:   Devendra Shekh
 ** Description: This stored procedure is used to Get Work Order Task Details By Id
 ** Date:  03-March-2025
...
**************************************************************/
CREATE   PROCEDURE [dbo].[GetWorkOrderTaskDetailsById]
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE	WTI.WorkOrderTaskDetailsId = @WorkOrderTaskDetailsId AND WTI.MasterCompanyId = @MasterCompanyId
	...
	BEGIN CATCH
	  DECLARE @ErrorLogID INT
			...
			,@AdhocComments VARCHAR(150) = 'GetWorkOrderTaskDetailsById'
			,@ProcedureParameters VARCHAR(3000) = '@Parameter1 = ''' + CAST(ISNULL(@WorkOrderTaskDetailsId, '') AS varchar(100))+
