 ...
 ** Author:  Deep Patel
 ** Description: This stored procedure is used to store repair order Management Structure Details
 ** Purpose:         
 ** Date:   07/03/2022        
...
-- EXEC PROCAddROMSData 47,3,5,2,'moin','moin',47,2,2
************************************************************************/

CREATE PROCEDURE [dbo].[PROCAddROMSData]
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'PROCAddROMSData' 
