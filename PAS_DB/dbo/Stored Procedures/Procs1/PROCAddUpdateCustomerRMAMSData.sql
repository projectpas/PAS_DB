 ...
 ** Description: This stored procedure is used to store RMA Management Structure Details
 ** Purpose:         
 ** Date:   18/04/2022      
 ...
 ** --   --------     -------		--------------------------------          
    1    18/04/2022  Subhash Saliya     Created
     
-- EXEC PROCAddUpdateCustomerRMAMSData 47,3,2,'moin','moin',47,2,2
************************************************************************/

CREATE PROCEDURE [dbo].[PROCAddUpdateCustomerRMAMSData]
@ReferenceId bigint,
@EntityMSID bigint,
@MasterCompanyId int,
