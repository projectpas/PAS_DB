...
/*************************************************************           
 ** File:   PROCUpdateModuleWiseMSData      
 ** Author:   Moin Bloch
 ...
 ** --   --------     -------		--------------------------------          
    1    03/07/2022   Moin Bloch       Created
     
 EXECUTE PROCUpdateModuleWiseMSData  2

**************************************************************/ 
 
CREATE PROCEDURE [dbo].[PROCUpdateModuleWiseMSData]    
(    
@ModuleId INT,
@ReferenceId BIGINT,
@EntityMSID BIGINT, 
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'PROCUpdateModuleWiseMSData' 
