 /*************************************************************           
 ** File:   [QuickBooks_GetCreditTermsUpdateSyncePendingList]           
 ...
 ** --   --------			-------				--------------------------------          
 ...
 EXECUTE [QuickBooks_GetCreditTermsUpdateSyncePendingList] 1
**************************************************************/ 
CREATE   PROCEDURE [dbo].[QuickBooks_GetCreditTermsUpdateSyncePendingList]
...
BEGIN
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetCreditTermsUpdateSyncePendingList'
