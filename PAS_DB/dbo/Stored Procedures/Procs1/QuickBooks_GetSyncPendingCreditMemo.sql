...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			WHERE	ISNULL(CMH.QuickBooksReferenceId, 0) = 0 AND ISNULL(CMH.IsUpdated, 0) = 1 AND CMH.CreditMemoHeaderId = @ReferenceId
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetSyncPendingCreditMemo'
