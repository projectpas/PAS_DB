/*************************************************************           
 ** File:   [QuickBooks_GetUpdateSyncPendingGLAccountList]           
 ** Author:   Devendra Shekh
 ** Description: Get GL Account List to Update Account in QuickBooks
 ** Purpose:         
 ** Date:   30-Jan-2025        
 ...
 ** --   --------		-------					--------------------------------          
 ...
 EXECUTE [QuickBooks_GetUpdateSyncPendingGLAccountList] 1, 1
**************************************************************/ 
CREATE   PROCEDURE [dbo].[QuickBooks_GetUpdateSyncPendingGLAccountList]
...
BEGIN
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetUpdateSyncPendingGLAccountList'
