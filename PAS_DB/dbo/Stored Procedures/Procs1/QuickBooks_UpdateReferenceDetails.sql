...
BEGIN
	...
	BEGIN TRY
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @VendorModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @InvModuleId AND @WOModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @InvModuleId AND @SOModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @InvModuleId AND @ExchModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @BillModuleId AND @NonPOModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @CustomerPaymentModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @CreditTermModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @GLAccountModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @POModuleId AND @PurchaseOrderModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @POModuleId AND @RepairOrderModuleId = @ReferenceModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @ItemModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @QBIntegrationTypeId AND @ModuleId = @CreditMemoModuleId) 
		BEGIN
		...
		-- Xero Accounting Customer
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @CustomerModuleId) 
		BEGIN
			UPDATE [dbo].[Customer] SET [QuickBooksReferenceId] =  @QuickBooksReferenceId, [IsUpdated] = 0, [LastSyncDate] = GETUTCDATE(), [SyncToken] = @SyncToken, [IntegrationTypeId] = @IntegrationTypeId WHERE [CustomerId] = @ReferenceId			
		END
		-- Xero Accounting Vendor
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @VendorModuleId) 
		BEGIN
			UPDATE [dbo].[Vendor] SET [QuickBooksReferenceId] =  @QuickBooksReferenceId, [IsUpdated] = 0, [LastSyncDate] = GETUTCDATE(), [SyncToken] = @SyncToken, [IntegrationTypeId] = @IntegrationTypeId WHERE [VendorId] = @ReferenceId			
		END
		-- Xero Accounting GLAccount
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @GLAccountModuleId) 
		BEGIN
		...
		END
		-- Xero Accounting ItemMaster
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @ItemModuleId) 
		BEGIN
		...
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @POModuleId) 
		BEGIN
		...
		END		
		-- Xero Accounting Work Order Invoice
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @InvModuleId AND @WOModuleId = @ReferenceModuleId) 
		BEGIN
			UPDATE [dbo].[BillingInvoicing] SET [QuickBooksReferenceId] = @QuickBooksReferenceId, [IsUpdated] = 0, [LastSyncDate] = GETUTCDATE(), [SyncToken] = @SyncToken, [IntegrationTypeId] = @IntegrationTypeId WHERE [BillingInvoicingId] = @ReferenceId AND [ModuleId] = @WOModuleId 		
		END
		-- Xero Accounting Sales Order Invoice
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @InvModuleId AND @SOModuleId = @ReferenceModuleId) 
		BEGIN
			UPDATE [dbo].[BillingInvoicing] SET [QuickBooksReferenceId] = @QuickBooksReferenceId, [IsUpdated] = 0, [LastSyncDate] = GETUTCDATE(), [SyncToken] = @SyncToken, [IntegrationTypeId] = @IntegrationTypeId WHERE [BillingInvoicingId] = @ReferenceId	AND [ModuleId] = @SOModuleId		
		END
		-- Xero Accounting Exchange Order Invoice
		IF(ISNULL(@IntegrationTypeId, 0) = @XeroIntegrationTypeId AND @ModuleId = @InvModuleId AND @ExchModuleId = @ReferenceModuleId) 
		BEGIN
