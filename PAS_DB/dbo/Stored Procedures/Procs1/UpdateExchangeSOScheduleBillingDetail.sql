CREATE Procedure [dbo].[UpdateExchangeSOScheduleBillingDetail]
...
BEGIN
	...
	BEGIN
			...
			UPDATE ExchangeSalesOrderScheduleBilling SET StatusId=2 WHERE ExchangeSalesOrderScheduleBillingId = @ExchangeSalesOrderScheduleBillingId
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
            , @AdhocComments     VARCHAR(150)    = 'UpdateExchangeSOScheduleBillingDetail' 
