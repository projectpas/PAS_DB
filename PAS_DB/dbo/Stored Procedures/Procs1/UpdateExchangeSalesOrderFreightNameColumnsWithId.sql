...
-- =============================================
--  EXEC [dbo].[UpdateExchangeSalesOrderFreightNameColumnsWithId] 5
CREATE PROCEDURE [dbo].[UpdateExchangeSalesOrderFreightNameColumnsWithId]
...
BEGIN
	...
	BEGIN
		...
		CurrencyName = c.Code
		FROM [dbo].[ExchangeSalesOrderFreight] soqf WITH (NOLOCK)
		...
		Where soqf.ExchangeSalesOrderId = @ExchangeSalesOrderId
	END
	COMMIT  TRANSACTION
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
            , @AdhocComments     VARCHAR(150)    = 'UpdateExchangeSalesOrderFreightNameColumnsWithId' 
