		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					...
					------Asset Account -----------
					 AND ISNULL(dbo.ItemMaster.IsNonStock,0) = 0 SELECT top 1 @DistributionSetupId=ID,@DistributionName=Name,@JournalTypeId =JournalTypeId,@IsAutoPost = ISNULL(IsAutoPost,0) 
