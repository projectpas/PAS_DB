/*************************************************************           
    ** File:   [USP_GetCustomerTaxTypeRateMapping]           
    ...
    ** --   --------		-------			--------------------------------          
    ...
    exec [dbo].[USP_GetCustomerTaxTypeRateMapping] @CustomerId=4293,@IsDeleted=0
 **************************************************************/
CREATE   PROCEDURE [dbo].[USP_GetCustomerTaxTypeRateMapping]
    @CustomerId BIGINT,
    @IsDeleted BIT
AS
BEGIN
