/*************************************************************           
 ** File:   [USP_GetCustomerTax_Information_ProductSale_Sales]           
 ** Author:   Moin Bloch
...
-- EXEC [USP_GetCustomerTax_Information_ProductSale_Sales] 3932,5064,19
**************************************************************/
CREATE   PROCEDURE [dbo].[USP_GetCustomerTax_Information_ProductSale_Sales] 
@CustomerId BIGINT,
...
BEGIN
  ...
  BEGIN CATCH
    DECLARE @ErrorLogID int,
            ...
            @AdhocComments varchar(150) = '[USP_GetCustomerTax_Information_ProductSale]',
