/*************************************************************           
 ** File:		 [USP_GetEntityInternationalWireByIdV2]           
 ** Author:		 Rajesh Gami
 ** Description: This Stored Procedure Is Used To Get Legal Entity International Wire By Id V2 (International Wire).
 ** Purpose:         
 ** Date:   08 OCT 2025 
 **************************************************************           
 ** Change History           
 ...
 ** --   -------------		----------------	--------------------------------          
 ...
 -- EXEC [USP_GetEntityInternationalWireByIdV2] @LegalEntityId=1,@EmployeeId=226
**************************************************************/
CREATE     PROCEDURE [dbo].[USP_GetEntityInternationalWireByIdV2]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			CASE WHEN t.[InternationalWirePaymentId] IS NOT NULL THEN 1 ELSE 0 END AS InternationaldataV2,
			t.[SwiftCode],
		...
		FROM [DBO].[InternationalWirePaymentV2] t WITH(NOLOCK)
		INNER JOIN [DBO].[LegalEntityInternationalWireBankingV2] ad WITH(NOLOCK) ON t.[InternationalWirePaymentId] = ad.[InternationalWirePaymentId]
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetEntityInternationalWireByIdV2'
