-- ===== PROCEDURE: [dbo].[USP_GetItemMasterForExchangeQuote_ById]   (file: _PAS_DB/PAS_DB/dbo/Stored Procedures/Procs2/USP_GetItemMasterForExchangeQuote_ById.sql) =====
/*********************           
 ** File:   [USP_GetItemMasterForExchangeQuote_ById]           
 ** Author:   Bhargav Saliya
 ** Description: Get ItemMaster Data for Exchnage loan By Id - for exchangepart
				while Creating Exchaneg from trading Page
 ** Purpose:         
 ** Date:   04-Jan-2024        
...
**********************/ 
CREATE   PROCEDURE [dbo].[USP_GetItemMasterForExchangeQuote_ById]
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetItemMasterForExchangeQuote_ById' 
              , @ProcedureParameters VARCHAR(3000)  = '@Parameter1 = '''+ ISNULL(@ItemMasterId, '') + ''', @Parameter2 = ' + ISNULL(@ConditionId,'') + ', @Parameter3 = ' + ISNULL(@CustomerId ,'') +''
