/*************************************************************           
 ** File:		 [USP_GetLegalEntityBankingChequeHistory]           
 ** Author:		 Rajesh Gami
 ...
 ** --   -------------		----------------	--------------------------------          
    1    09-09-2025		Rajesh Gami	Created
    
 -- EXEC [USP_GetLegalEntityBankingChequeHistory] @LegalEntityBankingChequeId=1,@EmployeeId=245
**************************************************************/
CREATE     PROCEDURE [dbo].[USP_GetLegalEntityBankingChequeHistory]
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT DISTINCT
            ...
            ISNULL(LBA.[LockboxNumber], '') AS LockboxNumber
        FROM [DBO].[LegalEntityBankingChequeAudit] LBA WITH (NOLOCK)
        ...
        WHERE LBA.[LegalEntityBankingChequeId] = @LegalEntityBankingChequeId
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetLegalEntityBankingChequeHistory'
