...
-- =====================================================================================
-- [MODIFIED] USP_GetMultipleTenderedStockLineList.sql
-- =====================================================================================

-- ===== PROCEDURE: [dbo].[USP_GetMultipleTenderedStockLineList]   (file: _PAS_DB/PAS_DB/dbo/Stored Procedures/Procs2/USP_GetMultipleTenderedStockLineList.sql) =====
/*************************************************************
 ...
 ** --   --------		-------				-------------------
	...
	4    15-Sep-2026			 RAJESH GAMI						[PN-17782] - Removed ISNULL(ITM.IsNonStock,0) = 0 AND ISNULL(STK.IsNonStock,0) = 0 exclusion from both the WorkOrderMaterials and WorkOrderMaterialsKit selects so Non-Stock tendered materials appear in the Create Multiple Stockline RO grid
