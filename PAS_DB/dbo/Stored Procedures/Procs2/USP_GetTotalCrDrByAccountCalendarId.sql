 ...
 ** --   --------     -------		-------------------------------            
	...
	5    07/03/2024   Hemant Saliya Modified (Remove Manual Journal)
**************************************************************/  
...
BEGIN
	BEGIN TRY	
		...
		BEGIN
			...
			AND BD.MasterCompanyId = @MasterCompanyId AND BD.StatusId = @PostedBatchStatusId
			AND CBD.IsDeleted = 0 AND CBD.IsActive = 1 AND BD.IsDeleted = 0 AND BD.IsActive = 1
