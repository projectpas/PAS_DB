 ...
 ** --   ----------   --------------  --------------------------------
	...
	13   05/24/2025   Hemant Saliya  Changed Logic to get trial Balance from begining
 **************************************************************
 ...
 exec dbo.USP_GetTrailBalanceReportData_Optimized @masterCompanyId=21, @managementStructureId=41, @AccountingPeriodId=322, @IsSupressZero=1, @IsShortMS=1, @strFilter=N'70!71'
  exec dbo.USP_GetTrailBalanceReportData @masterCompanyId=21, @managementStructureId=41, @AccountingPeriodId=323, @IsSupressZero=1, @IsShortMS=1, @strFilter=N'70!71'
*************************************************************/
        ...
        BEGIN
            ...
            BEGIN
                SELECT
					...
					(ISNULL(YTDDebitAmount, 0) - ISNULL(YTDCreditAmount, 0)) AS Balance,
