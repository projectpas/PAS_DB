 ...
 ** --   --------			-------			--------------------------------
	...
	6    22-Sep-2026			 RAJESH GAMI						[PN-17782] Removed the ISNULL(...IsNonStock,0)=0 restriction on the WorkOrderMaterials/WorkOrderMaterialsKit ItemMaster filters and the Stockline joins so Non-Stock parts appear in the WO Task material/billing list
