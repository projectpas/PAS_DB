 ...
 ** --   --------     -------		--------------------------------          
	...
	10   16-Sep-2026			 RAJESH GAMI						[PN-17782] - Removed "IM.ItemTypeId = @StkItemTypeId"/"IM.IsNonStock=0" from the #AllowItemMasterIds OEM/PMA/DER allow-list inserts and removed 12 more IsNonStock=0 exclusion filters (ItemMaster/Stockline joins via WorkOrderMaterials/WorkOrderMaterialsKit/NHA-TLA/Alt/Equ mapping) so Non-Stock materials are no longer hidden from the WO Material reserve stockline list.
