...
-- ---------------------------------------------------------------------------------------------------
-- Stored Procedure: dbo.usp_GetVendorRFQPartDetails   (source: PAS_DB/dbo/Stored Procedures/Procs2/usp_GetVendorRFQPartDetails.sql)
-- ---------------------------------------------------------------------------------------------------
/*************************************************************
...
SET NOCOUNT ON   
	...
	BEGIN
		...
		INNER JOIN [dbo].[ILSRFQDetail] ILSD WITH(NOLOCK) ON ILSD.ILSRFQDetailId = VRFQ.ILSRFQDetailId
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
			, @AdhocComments     VARCHAR(150)    = 'usp_GetVendorRFQPartDetails' 
