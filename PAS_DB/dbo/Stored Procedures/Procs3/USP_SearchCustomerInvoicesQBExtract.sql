 ...
 ** --   --------       -------			--------------------------------          
	...
	11    20/July/2026			 RAJESH GAMI						[PN-17350] - Removed IsNonStock=0 filter(s) from SO and Exchange-SO branches so Non-Stock parts appear in QuickBooks invoice extract (WorkOrder branch untouched).
**************************************************************/ 
