/*************************************************************               
 ** File:   [USP_UpdateNonPOInvoiceMSDetails]               
 ** Author:   Devendra Shekh      
 ** Description: to update managementstructuredetails for nonpoinvoice
 ** Purpose:             
 ...
 **************************************************************/   
CREATE   PROCEDURE [dbo].[USP_UpdateNonPOInvoiceMSDetails]  
(    
@ModuleId INT,
@ReferenceId BIGINT,
@EntityMSID BIGINT, 
		...
		BEGIN TRY
			BEGIN TRANSACTION
				BEGIN
					...
					FROM [dbo].[NonPOInvoiceManagementStructureDetails] MSD WITH(NOLOCK) 
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_UpdateNonPOInvoiceMSDetails' 
