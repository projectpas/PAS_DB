...
-- =====================================================================================
-- [MODIFIED] USP_UpdateSubWOSerialNumber_ByPartId.sql
-- =====================================================================================
 ...
 ** --   	--------		-------				--------------------------------
	...
	4		15-Sep-2026		RAJESH GAMI			    [PN-17782] - Allow Non-Stock ItemMaster/Stockline parts to flow through Sub WO Material lifecycle : Removed IsNonStock exclusion filters
