...
-- =====================================================================================
-- [MODIFIED] USP_UpdateWOCostDetails.sql
-- =====================================================================================

-- ---------------------------------------------------------------------------------------------------
-- Stored Procedure: dbo.USP_UpdateWOCostDetails   (source: PAS_DB/dbo/Stored Procedures/Procs3/USP_UpdateWOCostDetails.sql)
-- ---------------------------------------------------------------------------------------------------
/*************************************************************           
 ...
 ** --   --------     -------			--------------------------------          
 ...
 @WorkOrderWorkflowId=638,@UpdatedBy=N'admin',@MasterCompanyId=1
	...
	6    18-Sep-2026			 RAJESH GAMI						[PN-17782] Fixed same CATCH block: 'ISNULL(@WorkOrderId, '')'
									...
									ISNULL(CONVERT(VARCHAR(20), @WorkOrderId), '').
**************************************************************/ 
		...
		BEGIN TRANSACTION
			BEGIN
				...
				BEGIN
					...
					SET Revenue = ISNULL(TotalLaborCost,0) + ISNULL(MaterialCost,0)
					FROM #WOCostDetails
				END
