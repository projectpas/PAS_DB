 ...
 ** --   --------	   -------		--------------------------------          
	...
	13    18/08/2026	Moin Bloch		Added [IsInternalKitAssembly] PN-17372
	14    18/08/2026	Moin Bloch		Added [KitsToPrepare] on WorkOrderPartNumber PN-17372
...
BEGIN
	...
	INSERT INTO #tmprCreateWorkOrderPartNumber([ID],[WorkOrderId],[WorkOrderScopeId],[EstimatedShipDate],[CustomerRequestDate],[PromisedDate],[EstimatedCompletionDate],[NTE],[Quantity],
		   ...
		   [AircraftRegistryNumber],[IsFromAircraft],[AircraftInstalledPartDetailsId],[AircraftSerialNumber],[AircraftRegistryId],[ProgramId],[KitsToPrepare])
	SELECT [ID],@WorkOrderId,[WorkOrderScopeId],[EstimatedShipDate],[CustomerRequestDate],[PromisedDate],[EstimatedCompletionDate],[NTE],[Quantity],
		   ...
		   [AircraftRegistryNumber],[IsFromAircraft],[AircraftInstalledPartDetailsId],[AircraftSerialNumber],[AircraftRegistryId],[ProgramId],[KitsToPrepare] FROM @tbl_WorkOrderPartNumberType
