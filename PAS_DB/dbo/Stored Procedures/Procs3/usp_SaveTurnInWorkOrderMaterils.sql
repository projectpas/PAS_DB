...
@SerialNumber='SER-12123',@CustomerId=2449,@ObtainFromTypeId=1,@ObtainFrom=2449,
@ObtainFromName=N'GARRY WITTING',@OwnerTypeId=NULL,@Owner=NULL,@OwnerName=default,@TraceableToTypeId=NULL,
@TraceableTo=NULL,@TraceableToName=default,@Memo=N' ',@WorkOrderId=N'12330',@WorkOrderNumber=N'TWO000933',
@ManufacturerId=9,@InspectedById=NULL,@InspectedDate=NULL,@ReceiverNumber=N'RCTS#-000986',
@ReceivedDate='2026-05-26 01:23:19.950',@ManagementStructureId=1,@SiteId=2,@WarehouseId=NULL,
@LocationId=NULL,@ShelfId=NULL,@BinId=NULL,@MasterCompanyId=1,@UpdatedBy=N'HEMANT  SALIYA',
@WorkOrderMaterialsId=74781,@IsKitType=0,@Unitcost=2,@ProvisionId=4,@EvidenceId=0,@WorkOrderWorkflowId=12655,@IsMPNTendor=0
**************************************************************/
...
BEGIN
    ...
    BEGIN TRANSACTION;
        ...
        -- =============================================
        -- STEP 0: NORMALIZE NULL-ABLE INPUTS
        -- =============================================
        ...
        INNER JOIN DBO.ItemMaster IM ON STL.ItemMasterId = IM.ItemMasterId
	   ...
	   SELECT * FROM dbo.[udfGenerateCodeNumberWithOutDash](
        ...
        VALUES (
            @StockLineNumber, @ControlNumber, @IDNumber,
            @IsCustomerStock, @IsCustomerstockType, @ItemMasterId, @PartNumber,
            @UnitOfMeasureId, @ConditionId, @Quantity,
        ...
        BEGIN
            ...
            SET @OLDStockLineId = (
                SELECT StockLineId FROM [dbo].[WorkOrderPartNumber] WITH(NOLOCK) WHERE ID = @WorkOrderPartNoId
            );
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        SELECT
                            ...
                            @ConditionId, WOM.ItemClassificationId, @Quantity, @UnitOfMeasureId,
                    ...
                    BEGIN
                        ...
                        VALUES (
                            ...
                            @ConditionId, @ItemClassificationId, @Quantity, @UnitOfMeasureId,
                            0, 0, @Memo, 0,
                            0, 0, 1, @ProvisionId,
                            GETDATE(), @UpdatedBy, GETDATE(), @UpdatedBy,
                            @MasterCompanyId, 1, 0
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    SELECT
                        ...
                        @Quantity, @UnitOfMeasureId, 0, 0, @Memo,
                        WOM.IsDeferred, 0, 0,
