...
-- =====================================================================================
-- [NEW] usp_WorkOrderMaterials_GetStockLineList_ReserveIssue.sql
-- =====================================================================================

-- ===== PROCEDURE: [dbo].[usp_WorkOrderMaterials_GetStockLineList_ReserveIssue]   (file: _PAS_DB/PAS_DB/dbo/Stored Procedures/Procs3/usp_WorkOrderMaterials_GetStockLineList_ReserveIssue.sql) =====
/*************************************************************           
...
exec usp_WorkOrderMaterials_GetStockLineList_ReserveIssue @WorkFlowWorkOrderId=9904,@ItemMasterId=0,@WorkOrderMaterialsId=0,@KitId=0,@IncludeCustomerStock=0
	5    17/Sep/2026			 RAJESH GAMI						[PN-17782] - Removed the ItemTypeId=Stock / IsNonStock=0 exclusions from the #AllowItemMasterIds OEM/PMA/DER allow-list inserts (Restrict PMA/DER Parts feature), which were silently blocking Non-Stock OEM/PMA/DER-flagged materials.
**************************************************************/ 
