...
-- ---------------------------------------------------------------------------------------------------
-- Stored Procedure: dbo.usprpt_GetSOOperatingMetricReport_HMarginUnit   (source: PAS_DB/dbo/Stored Procedures/Procs3/usprpt_GetSOOperatingMetricReport_HMarginUnit.sql)
-- ---------------------------------------------------------------------------------------------------
/********************************************************************             
