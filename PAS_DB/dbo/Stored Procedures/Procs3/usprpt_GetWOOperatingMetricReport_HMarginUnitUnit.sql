...
-- ---------------------------------------------------------------------------------------------------
-- Stored Procedure: dbo.usprpt_GetWOOperatingMetricReport_HMarginUnitUnit   (source: PAS_DB/dbo/Stored Procedures/Procs3/usprpt_GetWOOperatingMetricReport_HMarginUnitUnit.sql)
-- ---------------------------------------------------------------------------------------------------
