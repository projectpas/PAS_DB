	...
	BEGIN TRY
		BEGIN TRANSACTION
			...
			;With Result AS(
				...
				P.Description, E.FirstName, E.LastName, IM.partnumber, IM.PartDescription, SOQ.VersionNumber, 
				...
				SELECT SalesOrderId, SalesOrderNumber, SalesOrderQuoteNumber, VersionNumber, OpenDate, CustomerId, CustomerName, CustomerReference, Priority, 
						...
						ShippedDate, SalesPerson, Status, StatusId, PartNumber, PartNumberType, PartDescription, PartDescriptionType,
