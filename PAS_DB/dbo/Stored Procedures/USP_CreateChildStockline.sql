    ...
    BEGIN TRANSACTION
      BEGIN
		...
		BEGIN
			...
			SELECT @ModuleId, @ReferenceId, @SubModuleId, @SubReferenceId, @StockLineId, STL.QuantityAvailable, STL.QuantityOnHand, STL.QuantityReserved, STL.QuantityIssued, 'New Stockline ('+ CAST(@StkLineNumber AS VARCHAR) +') Created.', 'AUTO SCRIPT', GETDATE(), 'AUTO SCRIPT', GETDATE(), @MasterCompanyId 
