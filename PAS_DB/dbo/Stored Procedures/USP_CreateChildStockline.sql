...
(  
 ...
 @MainLotStocklineId BIGINT =NULL,
 @IsFromInitialPO BIT = 0,
 @LotSourceId INT = 0
)  
AS  
BEGIN  
   ...
   BEGIN  
    ...
    BEGIN  
     ...
     SET [PartNumber] = STL.PartNumber  
	  ...
	  ,LotMainStocklineId = @MainLotStocklineId
	  ,IsFromInitialPO = @IsFromInitialPO
     ...
     BEGIN  
      ...
      BEGIN  
       ...
       BEGIN  
        ...
        SET @IdNumber = (SELECT * FROM dbo.udfGenerateCodeNumberWithOutDash(  
            @CurrentIdNumber,  
