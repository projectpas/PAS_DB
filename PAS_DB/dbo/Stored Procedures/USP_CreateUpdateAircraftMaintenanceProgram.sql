 ...
 ** --   --------		-------					--------------------------------
    ...
    9    01/06/2026     Ayushi Patel            [PN-16657] Save MaintenanceType from CapabilityType table
**************************************************************/
...
BEGIN
    ...
    BEGIN TRANSACTION
        ...
        SELECT @MaintenanceType = CapabilityTypeDesc FROM dbo.CapabilityType WITH(NOLOCK) WHERE CapabilityTypeId = @MaintenanceTypeId AND [IsActive]= 1 AND [IsDeleted] = 0;
