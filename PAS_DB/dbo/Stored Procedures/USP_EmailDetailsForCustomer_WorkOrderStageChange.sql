			  ...
			  BEGIN  
					...
					SELECT 
							...
							WOPN.MasterCompanyId
								...
								LEFT JOIN [dbo].[WorkScope] WS WITH(NOLOCK) ON WS.WorkScopeId = WOPN.WorkOrderScopeId
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_EmailDetailsForCustomer_WorkOrderStageChange' 
