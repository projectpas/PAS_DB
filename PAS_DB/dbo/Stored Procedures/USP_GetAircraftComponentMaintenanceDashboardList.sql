...
**                @SearchTailNumber  - dropdown filter, exact case-insensitive match
...
**                @SearchMaintenanceType - dropdown filter, exact case-insensitive match against
**                                     mtceType (AircraftMaintenanceProgram.MaintenanceType); NULL
**                                     for Source 2/INSTALLED rows so selecting a type correctly
**                                     excludes them
**                @ViewType          - 'Summary' rolls rows up to one per (acTailNum, section, pnNum)
**                                     group, keeping the row with the most Flight Hours remaining;
**                                     NULL/anything else (Detail View) leaves rows ungrouped, unchanged
** Change History
***********************************
...
(
	...
	@SearchMaintenanceType   VARCHAR(200) = NULL,
...
BEGIN
        ...
        BEGIN
            ...
            (
                ...
                SELECT
                    ...
                    ARH.AircraftRegistryNumber                                         AS aircraftRegistryNumber,
	                ...
	                CAST(AMP.TimeRemaining AS VARCHAR(20)) + ' Days' AS remainingTime,
                    ...
                    CAST(NULL AS INT)                                                  AS conditionId,
                    CAST(NULL AS DECIMAL(18,4))                                        AS quantity,
                    CAST(ISNULL(STK.QuantityAvailable, 0) AS DECIMAL(18,4))           AS quantityAvailable,
                ...
                SELECT
                    ...
                    --''                                               AS limitTime,
					CASE WHEN AIPD.ServiceLifeUnitMonthsOrDays = 1 THEN CAST(AIPD.ServiceLifeLimit AS VARCHAR(20)) + ' Mths'
					WHEN AIPD.ServiceLifeUnitMonthsOrDays = 2 THEN CAST(AIPD.ServiceLifeLimit AS VARCHAR(20)) + ' Days'
					ELSE '' END AS limitTime,
                    ...
                    CASE WHEN ISNULL(AIPD.PartEngineStarts,0) > 0 THEN ISNULL(AIPD.PartEngineStarts,0) - ISNULL(AIPD.EngineStarts,0) ELSE NULL END AS remainingEngineStarts,
                    CASE WHEN ISNULL(AIPD.PartFlightHours,0)=0 AND ISNULL(AIPD.PartFlightMinutes,0)=0 THEN 0
                         ...
                         ELSE ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))/60 END AS RemainingFlightHoursHours,
                    CASE WHEN ISNULL(AIPD.PartFlightHours,0)=0 AND ISNULL(AIPD.PartFlightMinutes,0)=0 THEN 0
                         WHEN ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))<0 THEN 0
                         ELSE ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))%60 END AS RemainingFlightHoursMinutes,
                    CAST(CASE WHEN ISNULL(AIPD.PartFlightHours,0)=0 AND ISNULL(AIPD.PartFlightMinutes,0)=0 THEN 0
                              WHEN ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))<0 THEN 0
                              ELSE ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))/60 END AS VARCHAR(10))
                    + ':' + RIGHT('00' + CAST(CASE WHEN ISNULL(AIPD.PartFlightHours,0)=0 AND ISNULL(AIPD.PartFlightMinutes,0)=0 THEN 0
                              WHEN ((CAST(ISNULL(AIPD.PartFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.PartFlightMinutes,0) AS INT))-(CAST(ISNULL(AIPD.InstallFlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.InstallFlightTime,0) AS INT))-(CAST(ISNULL(AIPD.FlightHours,0) AS INT)*60+CAST(ISNULL(AIPD.FlightMinutes,0) AS INT)))<0 THEN 0
                    ...
                    CAST(ISNULL(AIPD.Quantity, 0) AS DECIMAL(18,4))                   AS quantity,
                    CAST(ISNULL(STK.QuantityAvailable, 0) AS DECIMAL(18,4))           AS quantityAvailable,
            ...
            Paged AS (SELECT *, COUNT(1) OVER () AS TotalRecords FROM Grouped WHERE rn = 1)
            SELECT * FROM Paged
            ORDER BY
                CASE WHEN @SortColumn='ACTAILNUM'             AND @SortOrder='ASC'  THEN acTailNum END ASC,  CASE WHEN @SortColumn='ACTAILNUM'             AND @SortOrder='DESC' THEN acTailNum END DESC,
                CASE WHEN @SortColumn='ACMAKE'                AND @SortOrder='ASC'  THEN acMake END ASC,     CASE WHEN @SortColumn='ACMAKE'                AND @SortOrder='DESC' THEN acMake END DESC,
                CASE WHEN @SortColumn='SERIALNUM'             AND @SortOrder='ASC'  THEN serialNum END ASC,  CASE WHEN @SortColumn='SERIALNUM'             AND @SortOrder='DESC' THEN serialNum END DESC,
                CASE WHEN @SortColumn='MTCECATEGORY'          AND @SortOrder='ASC'  THEN mtceCategory END ASC, CASE WHEN @SortColumn='MTCECATEGORY'        AND @SortOrder='DESC' THEN mtceCategory END DESC,
                CASE WHEN @SortColumn='MTCETYPE'              AND @SortOrder='ASC'  THEN mtceType END ASC,   CASE WHEN @SortColumn='MTCETYPE'              AND @SortOrder='DESC' THEN mtceType END DESC,
                CASE WHEN @SortColumn='SECTION'               AND @SortOrder='ASC'  THEN section END ASC,    CASE WHEN @SortColumn='SECTION'               AND @SortOrder='DESC' THEN section END DESC,
                CASE WHEN @SortColumn='PNNUM'                 AND @SortOrder='ASC'  THEN pnNum END ASC,      CASE WHEN @SortColumn='PNNUM'                 AND @SortOrder='DESC' THEN pnNum END DESC,
                CASE WHEN @SortColumn='PNDESCRIPTION'         AND @SortOrder='ASC'  THEN pnDescription END ASC, CASE WHEN @SortColumn='PNDESCRIPTION'     AND @SortOrder='DESC' THEN pnDescription END DESC,
                CASE WHEN @SortColumn='QTY'                   AND @SortOrder='ASC'  THEN qty END ASC,        CASE WHEN @SortColumn='QTY'                   AND @SortOrder='DESC' THEN qty END DESC,
                CASE WHEN @SortColumn='CUSTOMERNAME'          AND @SortOrder='ASC'  THEN customerName END ASC, CASE WHEN @SortColumn='CUSTOMERNAME'        AND @SortOrder='DESC' THEN customerName END DESC,
                CASE WHEN @SortColumn='ATACHPT'               AND @SortOrder='ASC'  THEN ataChpt END ASC,    CASE WHEN @SortColumn='ATACHPT'               AND @SortOrder='DESC' THEN ataChpt END DESC,
                CASE WHEN @SortColumn='LASTMTCED'             AND @SortOrder='ASC'  THEN lastMtced END ASC,  CASE WHEN @SortColumn='LASTMTCED'             AND @SortOrder='DESC' THEN lastMtced END DESC,
                CASE WHEN @SortColumn='WONUM'                 AND @SortOrder='ASC'  THEN woNum END ASC,      CASE WHEN @SortColumn='WONUM'                 AND @SortOrder='DESC' THEN woNum END DESC,
                CASE WHEN @SortColumn='NEXTSCHDMTCE'          AND @SortOrder='ASC'  THEN nextSchdMtce END ASC, CASE WHEN @SortColumn='NEXTSCHDMTCE'        AND @SortOrder='DESC' THEN nextSchdMtce END DESC,
                CASE WHEN @SortColumn='INSTALLEDDATE'         AND @SortOrder='ASC'  THEN installedDate END ASC, CASE WHEN @SortColumn='INSTALLEDDATE'      AND @SortOrder='DESC' THEN installedDate END DESC,
                CASE WHEN @SortColumn='LIMITCYCLES'           AND @SortOrder='ASC'  THEN limitCycles END ASC, CASE WHEN @SortColumn='LIMITCYCLES'          AND @SortOrder='DESC' THEN limitCycles END DESC,
                CASE WHEN @SortColumn='LIMITTIME'             AND @SortOrder='ASC'  THEN limitTime END ASC,  CASE WHEN @SortColumn='LIMITTIME'             AND @SortOrder='DESC' THEN limitTime END DESC,
                CASE WHEN @SortColumn='LIMITLANDINGS'         AND @SortOrder='ASC'  THEN limitLandings END ASC, CASE WHEN @SortColumn='LIMITLANDINGS'      AND @SortOrder='DESC' THEN limitLandings END DESC,
                CASE WHEN @SortColumn='LIMITENGINESTARTS'     AND @SortOrder='ASC'  THEN limitEngineStarts END ASC, CASE WHEN @SortColumn='LIMITENGINESTARTS' AND @SortOrder='DESC' THEN limitEngineStarts END DESC,
                CASE WHEN @SortColumn='LIMITFLIGHTHOURS'      AND @SortOrder='ASC'  THEN LimitFlightHoursHours END ASC, CASE WHEN @SortColumn='LIMITFLIGHTHOURS' AND @SortOrder='DESC' THEN LimitFlightHoursHours END DESC,
                CASE WHEN @SortColumn='RECORDCYCLES'          AND @SortOrder='ASC'  THEN recordCycles END ASC, CASE WHEN @SortColumn='RECORDCYCLES'         AND @SortOrder='DESC' THEN recordCycles END DESC,
                CASE WHEN @SortColumn='RECORDTIME'            AND @SortOrder='ASC'  THEN recordTime END ASC, CASE WHEN @SortColumn='RECORDTIME'            AND @SortOrder='DESC' THEN recordTime END DESC,
                CASE WHEN @SortColumn='RECORDLANDINGS'        AND @SortOrder='ASC'  THEN recordLandings END ASC, CASE WHEN @SortColumn='RECORDLANDINGS'    AND @SortOrder='DESC' THEN recordLandings END DESC,
                CASE WHEN @SortColumn='RECORDENGINESTARTS'    AND @SortOrder='ASC'  THEN recordEngineStarts END ASC, CASE WHEN @SortColumn='RECORDENGINESTARTS' AND @SortOrder='DESC' THEN recordEngineStarts END DESC,
                CASE WHEN @SortColumn='RECORDFLIGHTHOURS'     AND @SortOrder='ASC'  THEN RecordFlightHoursHours END ASC, CASE WHEN @SortColumn='RECORDFLIGHTHOURS' AND @SortOrder='DESC' THEN RecordFlightHoursHours END DESC,
                CASE WHEN @SortColumn='REMAININGCYCLES'       AND @SortOrder='ASC'  THEN remainingCycles END ASC, CASE WHEN @SortColumn='REMAININGCYCLES'   AND @SortOrder='DESC' THEN remainingCycles END DESC,
                CASE WHEN @SortColumn='REMAININGTIME'         AND @SortOrder='ASC'  THEN remainingTime END ASC, CASE WHEN @SortColumn='REMAININGTIME'       AND @SortOrder='DESC' THEN remainingTime END DESC,
    ...
    END TRY
    BEGIN CATCH
        DECLARE @ErrorLogID INT, @DatabaseName VARCHAR(100) = DB_NAME(), @AdhocComments VARCHAR(150) = 'USP_GetAircraftComponentMaintenanceDashboardList', @ProcedureParameters VARCHAR(3000), @ApplicationName VARCHAR(100) = 'PAS';
        SET @ProcedureParameters = '@PageNumber=' + CAST(ISNULL(@PageNumber,0) AS VARCHAR(20)) + ', @PageSize=' + CAST(ISNULL(@PageSize,0) AS VARCHAR(20)) + ', @MasterCompanyId=' + CAST(ISNULL(@MasterCompanyId,0) AS VARCHAR(20));
        ...
        RAISERROR('Unexpected error in the database. Please provide error number %d to the support team.', 16, 1, @ErrorLogID);
        RETURN 1;
    END CATCH
END;