...
exec USP_GetEntityManagementStructureList @PageSize=10,@PageNumber=1,@SortColumn=N'EntityStructureId',@SortOrder=1,
		@GlobalFilter=N'',@Level1Name=NULL,@Level2Name=NULL,@Level3Name=NULL,@Level4Name=NULL,@Level5Name=NULL,@Level6Name=NULL,
		@Level7Name=NULL,@Level8Name=NULL,@Level9Name=NULL,@Level10Name=NULL,@MasterCompanyId=2,@EmployeeId=6,@EntityStructureId=9
**************************************************************/ 
CREATE PROCEDURE [dbo].[USP_GetEntityManagementStructureList]
	@PageNumber INT,
	@PageSize INT,
...
BEGIN
	...
	BEGIN TRY
		BEGIN TRANSACTION
			...
			;With Result AS(
				SELECT DISTINCT ESS.EntityStructureId,  --EUR.EmployeeId,
				...
				WHERE ((ESS.IsDeleted = 0) AND ESS.MasterCompanyId = @MasterCompanyId AND ISNULL(EUR.EmployeeId,0) = @EmployeeId) OR (ESS.EntityStructureId = @EntityStructureId)) , 
				FinalResult AS (
				SELECT EntityStructureId, Level1Id, Level1Name, Level2Id, Level2Name, Level3Id, Level3Name, Level4Id, Level4Name, --EmployeeId, 
				...
				WHERE (
					...
					SELECT EntityStructureId, Level1Id, Level1Name,Level2Id, Level2Name,Level3Id, Level3Name,Level4Id, Level4Name,Level5Id, Level5Name, --EmployeeId, 
