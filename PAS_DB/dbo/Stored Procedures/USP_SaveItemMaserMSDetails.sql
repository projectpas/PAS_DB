...
/*************************************************************           
 ** File:   [USP_SaveItemMaserMSDetails]           
...
CREATE PROCEDURE [dbo].[USP_SaveItemMaserMSDetails]    
(    
@ModuleID INT,
@ReferenceID BIGINT,
@EntityMSID BIGINT, 
		...
		BEGIN TRY
			BEGIN TRANSACTION
				BEGIN
					...
					INSERT INTO [dbo].[ItemMasterManagementStructureDetails]
					...
					SELECT @MSDetailsId = IDENT_CURRENT('ItemMasterManagementStructureDetails');
					...
					UPDATE [dbo].[ItemMasterManagementStructureDetails] 
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_SaveItemMaserMSDetails' 
