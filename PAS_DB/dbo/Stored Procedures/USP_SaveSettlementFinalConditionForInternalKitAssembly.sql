    ...
    SET NOCOUNT ON;
		...
		BEGIN
			...
			BEGIN				
				...
				DECLARE @QtyOrder INT,@SiteId BIGINT,@WarehouseId BIGINT = NULL,@LocationId BIGINT = NULL, @ShelfId BIGINT = NULL,@BinId BIGINT= NULL
				...
				DECLARE @Quantity INT = 1,@QuantityReserved INT = 0,@QuantityIssued INT = 0,@QuantityOnHand INT = 0,@QuantityAvailable INT = 0,@QtyReserved INT = 0,@QtyIssued INT = 0
