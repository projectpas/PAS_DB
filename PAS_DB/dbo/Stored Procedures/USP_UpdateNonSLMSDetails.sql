 ...
 ** --   --------     -------		--------------------------------          
 ...
 EXECUTE USP_UpdateNonSLMSDetails 2

**************************************************************/ 
 
CREATE PROCEDURE [dbo].[USP_UpdateNonSLMSDetails]    
(    
@ModuleId INT,
@ReferenceId BIGINT,
@EntityMSID BIGINT, 
		...
		BEGIN TRY
			BEGIN TRANSACTION
				BEGIN
					...
					FROM [dbo].[NonStocklineManagementStructureDetails] MSD WITH(NOLOCK) 
