 ...
 ** --   --------     -------		--------------------------------          
 ...
 exec sp_executesql N'exec USP_UpdateWOCostDetails_Test @WorkOrderId, @WorkOrderWorkflowId, @UpdatedBy, @MasterCompanyId ',N'@WorkOrderId bigint,
...
CREATE   PROCEDURE [dbo].[USP_UpdateWOCostDetails_Test]    
(    
