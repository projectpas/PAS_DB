-- EXEC [UpdateStockLineQtyFromSO]
CREATE PROCEDURE [dbo].[UpdateStockLineQtyFromSO]
@StockLineId BIGINT,
@SOSReserveId BIGINT,
@QtyReserved INT
...
BEGIN
	...
	BEGIN
		 ...
		 UPDATE SalesOrderStockLineReserve SET IsReserved = 0, UpdatedBy = 'PAS Service', UpdatedDate = GETDATE() 
		 WHERE SOSReserveId = @SOSReserveId
	END
	COMMIT  TRANSACTION
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
            , @AdhocComments     VARCHAR(150)    = 'UpdateStockLineQtyFromSO' 
