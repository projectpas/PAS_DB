    ...
    BEGIN 
		...
		END
		 ...
		 INSERT INTO [dbo].[Stockline](StockLineNumber, ControlNumber, IDNumber, IsCustomerStock,IsCustomerstockType,ItemMasterId,PartNumber, PurchaseUnitOfMeasureId,ConditionId,Quantity,   
		   ...
		   [OEM],IsPMA, IsDER,IsOemPNId, OEMPNNumber,GLAccountId,[IsStkTimeLife],[EvidenceId], [IntegrationPortal], AircraftInstalledPartDetailsId, AircraftTailNumber, AircraftSN,TotalTSN, TotalCSN, TotalTSNMM, TotalCSNMM
		   ...
		   @IsOEM,@IsPMA, @IsDER,@IsOemPNId, @OEMPNNumber,@GLAccountId, @IsTimeLife,@EvidenceId, @IntegrationPortal, @AircraftInstalledPartDetailsId, @AircraftTail, @AircraftSN, @TotalTSN, @TotalCSN, @TotalTSNMM,@TotalCSNMM );  
