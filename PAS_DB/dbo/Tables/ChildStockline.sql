CREATE TABLE [dbo].[ChildStockline] (
    [ChildStockLineId]                    BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [CreatedDate]                         DATETIME2 (7)   CONSTRAINT [DF_ChildStockline_CreatedDate] DEFAULT (getdate()) NULL,
    [UpdatedDate]                         DATETIME2 (7)   CONSTRAINT [DF_ChildStockline_UpdatedDate] DEFAULT (getdate()) NULL,
    ...
    [isActive]                            BIT             CONSTRAINT [DF__ChildStockline__isAct__13DCE752] DEFAULT ((1)) NOT NULL,
    [isDeleted]                           BIT             CONSTRAINT [DF__ChildStockline__isDel__14D10B8B] DEFAULT ((0)) NOT NULL,
