CREATE TABLE [dbo].[ManagementStructureDetailsAudit] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_ManagmentStructureDetailsAudit_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_ManagmentStructureDetailsAudit_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_ManagmentStructureDetailsAudit_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_ManagmentStructureDetailsAudit_IsDeleted] DEFAULT ((0)) NOT NULL,
    [LastMSLevel]     VARCHAR (200) NULL,
    [AllMSlevels]     VARCHAR (MAX) NULL,
    CONSTRAINT [PK_ManagmentStructureDetailsAudit] PRIMARY KEY CLUSTERED ([Id] ASC)
);
