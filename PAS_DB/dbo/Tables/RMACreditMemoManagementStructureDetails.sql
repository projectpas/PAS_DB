CREATE TABLE [dbo].[RMACreditMemoManagementStructureDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_RMACreditMemoManagementStructureDetails_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_RMACreditMemoManagementStructureDetails_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_RMACreditMemoManagementStructureDetails_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_RMACreditMemoManagementStructureDetails_IsDeleted] DEFAULT ((0)) NOT NULL,
