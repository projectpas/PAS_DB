CREATE TABLE [dbo].[SalesOrderApprovalAudit] (
    [AuditSalesOrderApprovalId] BIGINT         IDENTITY (1, 1) NOT NULL,
    [SalesOrderApprovalId]      BIGINT         NOT NULL,
    ...
    CONSTRAINT [PK_SalesOrderApprovalAudit] PRIMARY KEY CLUSTERED ([AuditSalesOrderApprovalId] ASC)
);
