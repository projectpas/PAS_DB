CREATE TABLE [dbo].[SalesOrderReservedStockAudit] (
    [SOReservedStockAuditId] BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_SalesOrderReservedStockAudit] PRIMARY KEY CLUSTERED ([SOReservedStockAuditId] ASC)
);
