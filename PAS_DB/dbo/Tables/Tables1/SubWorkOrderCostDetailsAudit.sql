CREATE TABLE [dbo].[SubWorkOrderCostDetailsAudit] (
    [SubWOCostDetailsAuditId] BIGINT          IDENTITY (1, 1) NOT NULL,
    [SubWOCostDetailsId]      BIGINT          NOT NULL,
    ...
    CONSTRAINT [PK_SubWorkOrderCostDetailsAudit] PRIMARY KEY CLUSTERED ([SubWOCostDetailsAuditId] ASC)
);
