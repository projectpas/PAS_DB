CREATE TABLE [dbo].[SubWorkOrder_ReleaseFrom_8130Audit] (
    [SubReleaseFromAuditId] BIGINT        IDENTITY (1, 1) NOT NULL,
    [SubReleaseFromId]      BIGINT        NOT NULL,
    ...
    CONSTRAINT [PK_SubWorkOrder_ReleaseFrom_8130Audit] PRIMARY KEY CLUSTERED ([SubReleaseFromAuditId] ASC)
);
