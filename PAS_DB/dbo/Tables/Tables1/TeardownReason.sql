CREATE TABLE [dbo].[TeardownReason] (
    ...
    CONSTRAINT [FK_TeardownReason_TeardownType] FOREIGN KEY ([TeardownTypeId]) REFERENCES [dbo].[TeardownType] ([TeardownTypeId]),
...
BEGIN
	...
	SELECT @TeardownTypeId=TeardownTypeId FROM INSERTED

	SELECT @TeardownType=Name FROM TeardownType WHERE TeardownTypeId=@TeardownTypeId
