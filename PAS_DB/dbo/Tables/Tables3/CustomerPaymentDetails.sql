CREATE TABLE [dbo].[CustomerPaymentDetails] (
    ...
    [Ismiscellaneous]                     BIT             CONSTRAINT [DF__CustomerP__Ismis__7A436B98] DEFAULT ((0)) NOT NULL,
    ...
    [IsNonInvoicePayment]                 BIT             CONSTRAINT [DF__CustomerP__IsNon__7B378FD1] DEFAULT ((0)) NULL,
