CREATE TABLE [dbo].[LotManagementStructureDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_LotManagementStructureDetails_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_LotManagementStructureDetails_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_LotManagementStructureDetails_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_LotManagementStructureDetails_IsDeleted] DEFAULT ((0)) NOT NULL,
    CONSTRAINT [PK_LotManagementStructureDetails] PRIMARY KEY CLUSTERED ([MSDetailsId] ASC)
);
