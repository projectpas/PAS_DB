CREATE TABLE [dbo].[SalesOrderManagementStructureDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_SalesOrderManagementStructureDetails_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_SalesOrderManagementStructureDetails_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_SalesOrderManagementStructureDetails_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_SalesOrderManagementStructureDetails_IsDeleted] DEFAULT ((0)) NOT NULL,
    [LastMSLevel]     VARCHAR (200) NULL,
    [AllMSlevels]     VARCHAR (MAX) NULL,
    CONSTRAINT [PK_SalesOrderManagementStructureDetails] PRIMARY KEY CLUSTERED ([MSDetailsId] ASC)
);
...
AS
BEGIN
INSERT INTO SalesOrderManagementStructureDetailsAudit
