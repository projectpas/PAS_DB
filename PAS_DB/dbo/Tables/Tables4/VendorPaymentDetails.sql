...
-- ("WHERE NPH.NonPOInvoiceId = VPD.NonPOInvoiceId"), which runs once per invoice row and was
-- doing a full table scan without this (see UOM_USP_GetNonPOInvoiceList_Deploy.sql for the
-- full review).
