CREATE TABLE [dbo].[VendorRFQPOChargesAudit] (
    [VendorRFQPOChargesAuditId] BIGINT          IDENTITY (1, 1) NOT NULL,
    [VendorRFQPOChargeId]       BIGINT          NOT NULL,
    ...
    [UOMId]                     BIGINT          NULL,
    CONSTRAINT [PK_VendorRFQPOChargesAudit] PRIMARY KEY CLUSTERED ([VendorRFQPOChargesAuditId] ASC)
);
