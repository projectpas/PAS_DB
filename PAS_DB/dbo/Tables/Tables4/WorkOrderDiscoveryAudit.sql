CREATE TABLE [dbo].[WorkOrderDiscoveryAudit] (
    [WorkOrderDiscoveryAuditId] BIGINT         IDENTITY (1, 1) NOT NULL,
    [WorkOrderDiscoveryId]      BIGINT         NOT NULL,
    ...
    CONSTRAINT [PK_WorkOrderDiscoveryAudit] PRIMARY KEY CLUSTERED ([WorkOrderDiscoveryAuditId] ASC)
);
