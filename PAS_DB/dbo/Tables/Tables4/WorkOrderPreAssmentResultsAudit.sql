CREATE TABLE [dbo].[WorkOrderPreAssmentResultsAudit] (
    [WorkOrderPreAssmentResultsAuditId] BIGINT         IDENTITY (1, 1) NOT NULL,
    [WorkOrderPreAssmentResultsId]      BIGINT         NOT NULL,
    ...
    CONSTRAINT [PK_WorkOrderPreAssmentResultsAudit] PRIMARY KEY CLUSTERED ([WorkOrderPreAssmentResultsAuditId] ASC)
);
