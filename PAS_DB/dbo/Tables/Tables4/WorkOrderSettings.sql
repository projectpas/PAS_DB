CREATE TABLE [dbo].[WorkOrderSettings] (
    ...
    [CapesRestrictionAtReceiving]      BIT            DEFAULT ((0)) NOT NULL,
    [CMMRestrictionAtReceiving]        BIT            DEFAULT ((0)) NOT NULL,
    [CMMWarningAtReceiving]            BIT            DEFAULT ((0)) NOT NULL,
    [CMMWarningAtShipping]             BIT            DEFAULT ((0)) NOT NULL,
    [CMMRestrictionAtShipping]         BIT            NULL,
    [ByPassCMMSettingAtShipping]       BIT            NULL,
    [CapesRestrictionAtShipping]       BIT            NULL,
    [CapesWarningAtReceiving]          BIT            NULL,
    [CapesWarningAtShipping]           BIT            NULL,
    [ByPassCapesSettingAtShipping]     BIT            NULL,
