...
BEGIN  
   ...
   SELECT WorkOrderStageId,Code,Stage,Sequence,StatusId,Description,Memo,MasterCompanyId,CreatedBy,UpdatedBy,CreatedDate,UpdatedDate,IsActive,IsDeleted,StageCode,CodeDescription,IncludeInDashboard,ManagerId,IsCustAlerts,@EmployeeName,IncludeInStageReport,WorkableBacklog,IncludeInTAT,QuoteDays,ShippedDays,ApprovedDays FROM INSERTED;  
