CREATE TABLE [dbo].[WorkOrderTaskInstructionAudit] (
    [WorkOrderTaskInstructionAuditId] BIGINT         IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_WorkOrderTaskInstructionAudit] PRIMARY KEY CLUSTERED ([WorkOrderTaskInstructionAuditId] ASC)
);
