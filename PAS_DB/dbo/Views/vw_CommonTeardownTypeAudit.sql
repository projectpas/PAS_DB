...
AS
	SELECT	CTTA.CommonTeardownTypeAuditId AS PkID, CommonTeardownTypeId AS ID, CommonTeardownTypeId AS 'TearDown Type Id', Name, Description, IsTechnician AS 'Technician ?', CTTA.[IsDate] AS 'Technician Date ?', IsInspector AS 'Inspector ?', IsInspectorDate AS 'Inspector Date ?', IsDocument AS 'Document ?'
