...
AS
	...
	,WPSA.IsActive AS 'Active ?', WPSA.IsDeleted AS 'Deleted ?', WPSA.CreatedBy as 'Created By', WPSA.UpdatedBy AS 'Updated By', WPSA.CreatedDate AS 'Created On', WPSA.UpdatedDate AS 'Updated On'
