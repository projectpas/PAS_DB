    ...
    BEGIN TRANSACTION
      BEGIN	
		...
		SELECT DISTINCT
			...
			part.FxRate fxRate,
			CASE WHEN stk.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(stk.QtyOrder, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(stk.QtyOrder,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 0, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(part.QtyOrder, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(part.QtyOrder,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 0, part.[MasterCompanyId]) END) END qty,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.UnitSalesPrice, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.UnitSalesPrice,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.UnitSalesPrice, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.UnitSalesPrice,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS unitSalePrice,
			...
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.DiscountAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.DiscountAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END)
			ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.DiscountAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.DiscountAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END discountAmount,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END netSales,
			...
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END markupPerUnit,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.UnitCost, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.UnitCost,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.UnitCost, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.UnitCost,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS unitCost,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.UnitSalesPriceExtended, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.UnitSalesPriceExtended,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.UnitSalesPriceExtended, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.UnitSalesPriceExtended,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END salesPriceExtended,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.MarkUpAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.MarkUpAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.MarkUpAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.MarkUpAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END markupExtended,
			0 salesDiscountExtended,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END netSalePriceExtended,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.UnitCostExtended, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.UnitCostExtended,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.UnitCostExtended, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.UnitCostExtended,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS unitCostExtended,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS marginAmount,
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.MarginAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.MarginAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END marginAmountExtended,
			...
			(CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(qs.QuantityAvailable, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(qs.QuantityAvailable,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 0, part.[MasterCompanyId]) END) AS qtyAvailable,
			ISNULL(iu.ShortName, '') AS uom,
			--ISNULL(rPart.QtyToReserve, NULL) AS qtyReserved,
			(CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(stk.QtyReserved, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(stk.QtyReserved, NULL), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 0, part.[MasterCompanyId]) END) AS qtyReserved,
			...
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.NetSaleAmount, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.NetSaleAmount,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS totalSales,
			...
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.UnitSalesPrice, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.UnitSalesPrice,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.UnitSalesPrice, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.UnitSalesPrice,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END unitSalesPricePerUnit,
			...
			CASE WHEN SOSC.SalesOrderStocklineId IS NOT NULL THEN (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOSC.NetSaleAmountPerUnit, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOSC.NetSaleAmountPerUnit,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) ELSE (CASE WHEN itemMaster.[StockUnitOfMeasure] = itemMaster.[ConsumeUnitOfMeasure] THEN ISNULL(SOPC.NetSaleAmountPerUnit, 0) ELSE [dbo].[fn_ConvertUOM](ISNULL(SOPC.NetSaleAmountPerUnit,0), itemMaster.[StockUnitOfMeasure], itemMaster.[ConsumeUnitOfMeasure], 1, part.[MasterCompanyId]) END) END AS netSalesPricePerUnit
		FROM DBO.SalesOrder so WITH(NOLOCK)
		INNER JOIN DBO.SalesOrderPartV1 part WITH(NOLOCK) ON so.SalesOrderId = part.SalesOrderId
