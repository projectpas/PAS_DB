...
***********************************************************************/  
CREATE OR ALTER PROCEDURE [dbo].[GetSOOperatingMetricReport_LMarginUnitUnitByIMId] 
@PageNumber int = 1,
@PageSize int = NULL,
@mastercompanyid int,
@xmlFilter XML
...
BEGIN  
  ...
  BEGIN CATCH  
    ...
    DECLARE @ErrorLogID int,  
            ...
            @AdhocComments varchar(150) = '[dbo.GetSOOperatingMetricReport_LMarginUnitUnitByIMId]',  
