 ...
 ** Description: This stored procedure is used retrieve workorder List for Auto complete Dropdown List    
 ** Purpose:         
 ** Date:   04/02/2020      
...
--EXEC [AutoCompleteDropdownsWorkorderList] '',20,'108,109,11',1
**************************************************************/

CREATE PROCEDURE [dbo].[AutoCompleteDropdownsWorkorderList]
...
AS
	...
	BEGIN TRY
		...
		--	BEGIN
				...
				WHERE (wo.IsActive=1 AND ISNULL(wo.IsDeleted,0)=0  and wo.WorkOrderStatusId=@workorderstatusid
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'AutoCompleteDropdownsWorkorderList'               
