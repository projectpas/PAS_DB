...
BEGIN  
 ...
 BEGIN TRY  
  ...
  BEGIN  
   ...
   WHERE sobi.InvoiceStatus = 'Invoiced' AND  --sobi.RemainingAmount > 0 AND ISNULL(sobi.IsBilling,0) = 0 
   ...
   ctm.[Name],ctm.NetDays,sobi.PostedDate,cr.Code,sobi.GrandTotal,sobi.RemainingAmount,sobi.IsProforma,DepositData.OriginalDepositAmt,DepositData.UsedDepositAmt     
   ...
   SELECT DISTINCT wobi.BillingInvoicingId AS InvoiceId,  
    ...
    ctm.NetDays,wobi.PostedDate,cr.Code,wobi.GrandTotal,wobi.RemainingAmount,wobi.IsPerformaInvoice,DepositData.OriginalDepositAmt,DepositData.UsedDepositAmt
  ...
  BEGIN  
   SELECT DISTINCT sobi.SOBillingInvoicingId AS InvoiceId,   
     ...
     WHERE sobi.InvoiceStatus = 'Invoiced' AND le.LegalEntityId = @ManagementStructureId AND so.CustomerId = @CustomerId AND   --AND ISNULL(sobi.IsBilling,0) = 0
