 ...
 ** --   --------		-------------		--------------------------------                
	...
	05	15-Jan-2025		Bhargav Saliya		Fixed the Duplicate Records Issue In POview
...
BEGIN      
	...
	,ResultData AS(      
		...
		OR         
			...
			,StatusId,VendorId,VendorName,VendorCode,[Status],RequestedBy,ApprovedBy,'' PartNumber,PartNumberType,'' Manufacturer,
			ManufacturerType,SalesOrderNumberType,RepairOrderNumberType,RepairOrderNumber , SalesOrderNumber,WorkOrderNum,
			CreatedDate,UpdatedDate,NumberOfItems,CreatedBy,UpdatedBy, '' EstDeliveryDate,EstDeliveryType,
			PurchaseOrderPartRecordId,QuantityOrdered,QuantityBackOrdered,QuantityReceived,WorkOrderNumType FROM ResultData,CTE_Count      
		ORDER BY      
