 ...
 ** --   --------         -------		     ----------------------------   
    ...
    3    22 APRIl 2024	Devendra Shekh        added data InvoiceTypeId and removed IsExchange field       
    ...
    BEGIN  
		...
		BEGIN  
			...
			INSERT([CreditMemoHeaderId],[RMAHeaderId],[InvoiceId],[ItemMasterId],[PartNumber],  
				...
				[UpdatedBy],[CreatedDate],[UpdatedDate],[IsActive],[IsDeleted],[RMADeatilsId],BillingInvoicingItemId,InvoiceTypeId)  
			VALUES(SOURCE.CreditMemoHeaderId,SOURCE.RMAHeaderId,SOURCE.InvoiceId,SOURCE.ItemMasterId,SOURCE.PartNumber,  
				...
				SOURCE.UpdatedBy,SOURCE.CreatedDate,SOURCE.UpdatedDate,SOURCE.IsActive,SOURCE.IsDeleted,SOURCE.RMADeatilsId,SOURCE.BillingInvoicingItemId,SOURCE.InvoiceTypeId);   
			END  
