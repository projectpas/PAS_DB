 ...
 ** --   --------     -------		--------------------------------          
	...
	2    12/25/2023   BHARGAV SALIYA  CONVERT DATE IN UTC
**************************************************************/
-----------------------------------------------------------------------------------------------------
/*************************************************************
	...
	SET NOCOUNT ON;
		...
		BEGIN TRANSACTION
			BEGIN  
				...
				--DECLARE @GLAccountId decimal(18,2);
			...
			WHERE StockLineId = @StocklineId
				...
				--ELSE
				--BEGIN
				--	EXEC [dbo].[USP_CreateChildStockline]  @StocklineId, @MasterCompanyId, @ModuleID, 1, 0, 0, 0, 0, 1, 33,0
				--END
