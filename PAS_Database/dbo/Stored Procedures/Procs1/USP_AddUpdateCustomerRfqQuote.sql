...
/*************************************************************           
 ** File:   [USP_AddUpdateCustomerRfqQuote]           
 ** Author:  Amit Ghediya
 ** Description: This stored procedure is used USP_AddUpdateCustomerRfqQuote
 ** Purpose:         
 ** Date:   20/02/2023      
...
-- EXEC USP_AddUpdateCustomerRfqQuote
************************************************************************/
CREATE   PROCEDURE [dbo].[USP_AddUpdateCustomerRfqQuote]
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
            , @AdhocComments     VARCHAR(150)    = 'USP_AddUpdateCustomerRfqQuote' 
