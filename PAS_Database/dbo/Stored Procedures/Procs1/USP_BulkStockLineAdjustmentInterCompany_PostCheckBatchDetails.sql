 ...
 ** --   --------     -------		  --------------------------------          
	...
	9	 20/09/2024   Rajesh Gami      Update the StocklineAdjustment modulename while adjustment.
...
BEGIN 
	BEGIN TRY
		...
		SELECT @Amount = SUM(ISNULL(AdjustmentAmount,0))
		...
		BEGIN 
			...
			SET @JournalBatchDetailId=SCOPE_IDENTITY()
				...
				--select * from #tmpBulkStockLineAdjustmentDetails;
	...
	BEGIN CATCH
		...
		-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_BulkStockLineAdjustmentInterCompany_PostCheckBatchDetails' 
