...
BEGIN  
		...
		DECLARE @CurrentIndex BIGINT;
			...
			WHILE (@LoopID > 0)
				BEGIN 
					...
					--INSERT INTO @p2 VALUES(@NewStocklineId, @QtyAdded, @PurchaseOrderUnitCostAdded, 'BulkStockline', @UpdatedBy, @MasterCompanyId, 'STOCK')
  ...
  BEGIN CATCH  
    ...
    ERROR_MESSAGE() AS ErrorMessage;
	  ...
	  ,@AdhocComments varchar(150) = 'USP_CreateStockline_BulkStockLineAdjustment'  
