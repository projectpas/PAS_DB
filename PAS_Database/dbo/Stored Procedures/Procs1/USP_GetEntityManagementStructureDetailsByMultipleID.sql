 ...
 ** --   --------     -------		--------------------------------          
    1    02/17/2022   Subhash Saliya Created
     
-- EXEC [USP_GetEntityManagementStructureDetailsByMultipleID] 21
**************************************************************/

Create PROCEDURE [dbo].[USP_GetEntityManagementStructureDetailsByMultipleID]
@EntityStructureId varchar(50)
AS
BEGIN
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetEntityManagementStructureDetailsByMultipleID' 
