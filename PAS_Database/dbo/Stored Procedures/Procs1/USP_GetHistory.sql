 ...
 BEGIN TRY  
  BEGIN TRANSACTION  
   ...
   DECLARE @RecordFrom INT;  
    ...
    FinalResult AS (  
    SELECT HistoryId, ModuleId, WorkOrderNum, partnumber, OldValue, NewValue, HistoryText, FieldsName  
    ...
    WHERE (  
     (@GlobalFilter <>'' AND ((HistoryId like '%' +@GlobalFilter+'%') OR   
      ...
      SELECT HistoryId, ModuleId, WorkOrderNum, partnumber, OldValue, NewValue, HistoryText, FieldsName,CreatedDate, UpdatedDate, CreatedBy, UpdatedBy,  
