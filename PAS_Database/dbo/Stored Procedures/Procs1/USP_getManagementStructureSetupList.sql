/***************************************************************  
 ** File:   [USP_getManagementStructureSetupList]             
 ** Author:   Unknown
 ** Description: This stored procedure is used to Get Management Structure List
 ** Date:  Unknown
 ...
 ** --   --------			-------				--------------------------------            
	...
	exec dbo.USP_getManagementStructureSetupList @PageSize=10,@PageNumber=1,@SortColumn=N'EntityStructureId',@SortOrder=1,@GlobalFilter=N'',@Level1Name=NULL,@Level2Name=NULL,
												 ...
												 @CreatedDate=NULL,@UpdatedDate=NULL,@CreatedBy=NULL,@UpdatedBy=NULL,@IsDeleted=0,@MasterCompanyId=1,@OrganizationTagTypeName=NULL,
												 @EmployeeId=226
		...
		BEGIN TRANSACTION
			...
			;With Result AS(
				SELECT ESS.EntityStructureId, --LE.[Name] AS Level1Name,
					...
					ESS.CreatedBy, ESS.UpdatedBy,ISNULL(OTT.OrganizationTagTypeId,0)AS OrganizationTagTypeId,OTT.[Name] AS OrganizationTagTypeName
