 ...
 **************************************************************           
	...
	2	 11/04/2024	  VISHAL SUTHAR	     Modified to make use of new SOQ-SO part tables
...
**************************************************************/
CREATE OR ALTER PROCEDURE [dbo].[usp_GetSalesOrderQuoteConversionReport] @customername varchar(40) = NULL,
@Fromdate datetime,
@Todate datetime,
