			...
			BEGIN TRANSACTION
				BEGIN
					...
					BEGIN
						...
						FROM dbo.SubWorkOrderMaterialsKit WOM JOIN #tmpIssueSWOMaterialsStockline tmpWOM ON tmpWOM.SubWorkOrderMaterialsKitId = WOM.SubWorkOrderMaterialsKitId AND tmpWOM.ID = @countKIT
