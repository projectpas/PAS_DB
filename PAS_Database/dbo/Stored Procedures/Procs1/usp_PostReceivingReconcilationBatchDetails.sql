			...
			BEGIN
				...
				BEGIN
					...
					BEGIN
						...
						SET @batch = CASE
							WHEN CAST(@Currentbatch AS BIGINT) > 99 THEN CAST(@Currentbatch AS VARCHAR(100))
							WHEN CAST(@Currentbatch AS BIGINT) > 9  THEN CONCAT('0',  CAST(@Currentbatch AS VARCHAR(50)))
