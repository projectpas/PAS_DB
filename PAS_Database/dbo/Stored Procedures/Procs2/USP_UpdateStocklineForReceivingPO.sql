 ...
 ** --   --------     -------			--------------------------------            
    ...
    3    04/08/2024   Vishal Suthar		Modified to update IsParent based on (Serialized) flag modified at the time of receiving
  	...
  	5    11-05-2026   Priyansh Patel    Added the AircraftTailnumber for update stockdraft table
  ...
  SET NOCOUNT ON
    ...
    BEGIN
		...
		(
			...
			[PurchaseOrderExtendedCost] [decimal](18, 6) NULL,
		...
		BEGIN
			...
			StkDraft.AircraftTailNumber = TmpStkDraft.AircraftTailNumber
