...
SET NOCOUNT ON   
	...
	select isnull(smtpsettingId,0)smtpsettingId,Employee.EmployeeId,smtpserver,emailpassword,isnull(portno,0)portno,email,emailtype,verifyemail,ISNULL(IsIncludeInCC,0) AS IsIncludeInCC from Employee 
