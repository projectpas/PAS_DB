 /*************************************************************           
 ** File:   [QuickBooks_GetCreditTermById]           
 ...
 ** --   --------			-------				--------------------------------          
 ...
 EXECUTE [QuickBooks_GetCreditTermById] 6, 1
**************************************************************/ 
CREATE   PROCEDURE [dbo].[QuickBooks_GetCreditTermById]
...
BEGIN
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetCreditTermById'
