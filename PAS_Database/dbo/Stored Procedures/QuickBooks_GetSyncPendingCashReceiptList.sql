/*************************************************************           
 ** File:   [QuickBooks_GetSyncPendingCashReceiptList]           
 ** Author:   Devendra Shekh
 ** Description: Get Cash Receipt List to Create Payment in QuickBooks    
 ** Purpose:         
 ** Date:   26-Nov-2024        
 ...
 ** --   --------		-------					--------------------------------          
 ...
 EXECUTE [QuickBooks_GetSyncPendingCashReceiptList] 1
**************************************************************/ 
CREATE   PROCEDURE [dbo].[QuickBooks_GetSyncPendingCashReceiptList]
...
BEGIN
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetSyncPendingCashReceiptList'
