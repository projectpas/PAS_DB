 ...
 ** --   --------		-------					--------------------------------          
 ...
 EXECUTE [QuickBooks_GetSyncPendingExChangeInvoiceList] 1
**************************************************************/ 
	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				[TermQuickBooksReferenceId], [TaxRateRef], [TxnTaxCodeRef], [MaterialCost], [MiscCharges], [FreightCost], [PercentValue])
