 ...
 ** --   --------		-------					--------------------------------          
 ...
 EXECUTE [QuickBooks_GetSyncPendingSOInvoiceList] 1
**************************************************************/ 
	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				[TermQuickBooksReferenceId], [TaxRateRef], [TxnTaxCodeRef], [MaterialCost], [MiscCharges], [FreightCost], [PercentValue], [ItemQuickBooksReferenceId])
