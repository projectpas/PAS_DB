 /*************************************************************           
 ** File:   [QuickBooks_GetUpdateCreditTermsList]           
 ...
 ** --   --------			-------				--------------------------------          
 ...
 EXECUTE [QuickBooks_GetUpdateCreditTermsList] 1
**************************************************************/ 
CREATE   PROCEDURE [dbo].[QuickBooks_GetUpdateCreditTermsList]
...
BEGIN
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'QuickBooks_GetUpdateCreditTermsList'
