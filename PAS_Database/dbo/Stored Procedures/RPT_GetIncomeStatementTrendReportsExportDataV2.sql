...
BEGIN   
 BEGIN TRY 
		 ...
		 END
		  ...
		  SELECT  @LevelCOUNT = MAX(LevelId) fROM #ReportingStructureExportData  WHERE IsLeafNode = 0
		  	  ...
		  	  BEGIN
		  		 ...
		  		 UPDATE #ReportingStructureExportData 
		  		   ...
		  		   FROM #ReportingStructureExportData RS
		  				WHERE LevelId = @LevelCOUNT AND IsProcess = 0 AND RS.AccountcalMonth = @AccCalMonth
		  
		  		UPDATE #ReportingStructureExportData 
		  			   SET IsProcess = 1
		  			   WHERE LevelId = @LevelCOUNT AND AccountcalMonth = @AccCalMonth
