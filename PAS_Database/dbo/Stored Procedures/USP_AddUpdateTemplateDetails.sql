 ...
 ** --   --------			-------					--------------------------------
	...
	5    17-APR-2026       Priyansh Patel           Added AC Template Fields [PN-15968]
		...
		BEGIN
			...
			WHEN NOT MATCHED THEN
				INSERT (
					...
					[PercentageOfOthers], [PercentageOfTotal], [RevisedPartNumber], [ChangedPartNumberDescription], [ChangedPartNumber], [WorkScope], [Currency], [WFParentId], [IsVersionIncrease], [Verified], [VerifiedBy], [VerifiedDate],[TailNum], [SerialNum], [AircraftModelId], [MakeTypeId], [TemplateType]
				)
				VALUES (
					...
					[Source].[TailNum], [Source].[SerialNum], [Source].[AircraftModelId], [Source].[MakeTypeId], [Source].[TemplateType]
				);
