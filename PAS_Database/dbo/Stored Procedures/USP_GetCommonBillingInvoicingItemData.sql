 ...
 ** --   --------     -------		--------------------------------          
	...
	6    20/July/2026			 RAJESH GAMI						[PN-17350] - Removed IsNonStock=0 filter(s) so Non-Stock parts appear/populate correctly on SO billing/invoicing item data (WorkOrder branch untouched).
