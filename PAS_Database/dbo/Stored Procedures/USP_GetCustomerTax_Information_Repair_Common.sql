/*************************************************************           
 ** File:   [USP_GetCustomerTax_Information_Repair_Common]           
 ** Author:   Moin Bloch
...
-- EXEC [USP_GetCustomerTax_Information_Repair_Common] 3932,5064,19
**************************************************************/
CREATE     PROCEDURE [dbo].[USP_GetCustomerTax_Information_Repair_Common] 
@CustomerId BIGINT,
...
BEGIN
  ...
  BEGIN CATCH
    DECLARE @ErrorLogID int,
            ...
            @AdhocComments varchar(150) = '[USP_GetCustomerTax_Information_Repair_Common]',
