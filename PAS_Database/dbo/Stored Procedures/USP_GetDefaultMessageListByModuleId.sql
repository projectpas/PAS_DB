/*************************************************************           
 ** File:   [USP_GetDefaultMessageListByModuleId]           
 ** Author:   Rajesh Gami
 ** Description: This stored procedure is used to get Default messag liste by module id  
 ** Purpose:         
 ** Date:   11 Nov 2025              
 ...
 ** --   --------     -------		--------------------------------          
   ...
   EXECUTE [USP_GetDefaultMessageListByModuleId] 13,1
**************************************************************/ 
    
CREATE     PROCEDURE [dbo].[USP_GetDefaultMessageListByModuleId]
@ModuleId  BIGINT,
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetDefaultMessageListByModuleId' 
