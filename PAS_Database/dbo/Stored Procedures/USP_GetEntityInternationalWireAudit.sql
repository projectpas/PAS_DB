/*************************************************************           
 ** File:		 [USP_GetEntityInternationalWireAudit]           
 ...
 ** --   -------------		----------------	--------------------------------          
 ...
 -- EXEC [USP_GetEntityInternationalWireAudit] @LegalEntityId=1, @EmployeeId=226
**************************************************************/
CREATE   PROCEDURE [DBO].[USP_GetEntityInternationalWireAudit]
...
BEGIN
	...
	BEGIN TRY
        ...
        FROM [DBO].[InternationalWirePaymentAudit] IWPA WITH(NOLOCK)
        LEFT JOIN [DBO].[LegalEntityInternationalWireBanking] LEIWB WITH(NOLOCK) ON IWPA.[InternationalWirePaymentId] = LEIWB.[InternationalWirePaymentId]
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
              , @AdhocComments     VARCHAR(150)    = 'USP_GetEntityInternationalWireAudit'
