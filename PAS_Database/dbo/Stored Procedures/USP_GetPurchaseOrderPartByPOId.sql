	...
	SET NOCOUNT ON;
		...
		BEGIN TRANSACTION
			BEGIN
				...
				part.VendorListPrice,
				part.DiscountPercent,
				part.DiscountPerUnit,
				part.DiscountAmount,
				part.UnitCost,
				part.ExtendedCost,
				part.FunctionalCurrencyId,
				part.FunctionalCurrency,
				part.ForeignExchangeRate,
				part.ReportCurrencyId,
				part.ReportCurrency,
				part.WorkOrderId,
				part.WorkOrderNo,
				part.SubWorkOrderId,
				...
				part.ReapairOrderNo,
				part.SalesOrderId,
				SoCount = (SELECT COUNT(POPR.ReferenceId) FROM DBO.PurchaseOrderPartReference POPR WITH(NOLOCK) WHERE POPR.PurchaseOrderPartId = part.PurchaseOrderPartRecordId),
				part.SalesOrderNo,
				part.ItemTypeId,
				part.ItemType,
				part.GlAccountId,
				...
				part.isParent,
				part.Memo,
				part.POPartSplitUserTypeId,
				part.POPartSplitUserType,
				part.POPartSplitUserId,
				part.POPartSplitUser,
				part.POPartSplitSiteId,
				part.POPartSplitSiteName,
				part.POPartSplitAddressId,
				part.POPartSplitAddress1,
				part.POPartSplitAddress2,
				part.POPartSplitAddress3,
				part.POPartSplitCity,
				part.POPartSplitState,
				part.POPartSplitPostalCode,
				part.POPartSplitCountryId,
				part.POPartSplitCountryName,
				...
				part.IsActive,
				part.IsDeleted,
				part.DiscountPercentValue,
				part.EstDeliveryDate,
				part.ExchangeSalesOrderId,
				part.ExchangeSalesOrderNo,
				part.ManufacturerPN,
				part.AssetModel,
				part.AssetClass,
				part.IsLotAssigned,
				part.LotId,
				part.WorkOrderMaterialsId,
				part.VendorRFQPOPartRecordId,
				part.TraceableTo,
				part.TraceableToName,
				part.TraceableToType,
				part.TagTypeId,
				part.TaggedBy,
				part.TaggedByType,
				part.TaggedByName,
				part.TaggedByTypeName,
				part.TagDate,
				part.IsKit,
				part.IsSubWO,
				part.SalesOrderQuoteId,
				part.SalesOrderQuoteNumber,
					...
					BEGIN -->>>>> Start: While Loop Main
						...
						BEGIN -->> START:  @isParentPart = 1 If
							...
							INSERT INTO #mainReturnTable (
								...
								POFrightsCount,
								SalesOrderQuoteId,
								SalesOrderQuoteNumber,Class,DecimalPlaces
								)
