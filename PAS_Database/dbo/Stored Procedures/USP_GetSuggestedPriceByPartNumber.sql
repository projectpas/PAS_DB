/*************************************************************           
 ** File:  [USP_GetSuggestedPriceByPartNumber]           
 ** Author:  Rajesh Gami
 ...
 ** --   ----------  -----------		--------------------------------          
    1    01/Oct/2025  Rajesh Gami		    Created

  EXEC [dbo].[USP_GetSuggestedPriceByPartNumber] 'NICKITEST-A',7,1
  EXEC [dbo].[USP_GetSuggestedPriceByPartNumber] '1150-C',2,1
  
************************************************************************/
CREATE   PROCEDURE [dbo].[USP_GetSuggestedPriceByPartNumber]
