 ...
 ** --   --------		-------			--------------------------------          
 ...
 EXECUTE [USP_GetXeroVendorList] 3,1
**************************************************************/ 
CREATE PROCEDURE [dbo].[USP_GetXeroVendorList]
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN			
			SELECT
				...
				CST.[MasterCompanyId],
				CST.[UpdatedBy]
			FROM [dbo].[Vendor] CST WITH(NOLOCK)			
	...
	BEGIN CATCH      
			...
			,@AdhocComments VARCHAR(150) = 'USP_GetXeroVendorList'
