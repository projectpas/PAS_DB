				...
				BEGIN
					...
					CREATE TABLE #SubWorkOrderMaterials
							(
								 ...
								 [QuantityReserved] [decimal](18,6) NULL,
								 [QuantityIssued] [decimal](18,6) NULL,
								 [QuantityShort] [decimal](18,6) NULL,
								 [IsAltPart] [bit] NULL,
								 [AltPartMasterPartId] [bigint] NULL,
								 [PartStatusId] [decimal](18,6) NULL,
								 [UnReservedQty] [decimal](18,6) NULL,
								 [UnIssuedQty] [decimal](18,6) NULL,
								 [IssuedById] [bigint] NULL,
								 [ReservedById] [bigint] NULL,
								 ...
								 [StkQuantity] [decimal](18,6) NULL,
								 [QtyReserved] [decimal](18,6) NULL,
								 [QtyIssued] [decimal](18,6) NULL,			
								 [StkQuantityShort] [decimal](18,6) NULL,
								 [StkAltPartMasterPartId] [bigint] NULL,
								 [StkEquPartMasterPartId] [bigint] NULL,
								 [StkIsAltPart] [bit] NULL,
								 [StkIsEquPart] [bit] NULL,
								 [StkUnitCost] [decimal](18,6) NULL,
								 [StkExtendedCost] [decimal](18,6) NULL,								 
					...
					SELECT DENSE_RANK() OVER (ORDER BY ISNULL(wom.StockLineId,0) DESC) AS RowNumber , 
						...
						UPPER([ControlId]) AS [ControlId],UPPER([UOM]) AS [UOM],UPPER([Priority]) AS [Priority],[QtyAvail],[QtyOH],	UPPER(wom.[Location]) AS [Location],UPPER([Wherehouse]) AS [Wherehouse], UPPER(wom.[Shelf]) AS [Shelf], UPPER(wom.[Bin]) AS [Bin],[IsMaterials]
