/*************************************************************
** File:   [USP_RestoreVendorBillingAddress]        
** Author:  Ayushi Patel
** Description: Restores (un-deletes) Vendor Billing Address by setting IsDeleted = 0, and calls ShippingBillingAddressHistory.
** Purpose: 
** Date:   29/04/2025     
...
--exec [dbo].[USP_RestoreVendorBillingAddress]  7796, 'ADMIN User'
************************************************************************/

CREATE   PROCEDURE USP_RestoreVendorBillingAddress
    @VendorBillingAddressId BIGINT,
    @UpdatedBy NVARCHAR(255)
AS
BEGIN
...
-----------------------------------PLEASE CHANGE THE VALUES FROM HERE TILL THE NEXT LINE----------------------------------------
                @AdhocComments VARCHAR(150) = 'USP_RestoreVendorBillingAddress',
