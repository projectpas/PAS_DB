/*************************************************************               
 ** File:  [usprpt_GetCertificationReport]      
 ** Author:  Bhargav Saliya
 ** Description: This stored procedure is used to GetCertificationReport DATA.    
 ** Purpose:             
 ** Date:   25-Feb-2025          
...
BEGIN  
  ...
  BEGIN TRY  
   ...
   ;WITH rptCTE (TotalRecordsCount, EmployeeId, firstName, lastName, title, expertise, email, phone, certType,
      ...
      SELECT COUNT(1) OVER () AS TotalRecordsCount,
       ...
       CASE WHEN ISNULL(EC.IsCertificationInForce,0) = 1 THEN 'YES' ELSE 'NO' end AS enforce,
  ...
  BEGIN CATCH  
    ...
    DECLARE @ErrorLogID int,  
            ...
            @AdhocComments varchar(150) = '[usprpt_GetCertificationReport]',  
