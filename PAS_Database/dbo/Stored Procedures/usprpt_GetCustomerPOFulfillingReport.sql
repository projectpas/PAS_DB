 ...
 ** --   --------         -------          --------------------------------            
	...
	6	 15-07-2026		  Abhishek Jirawla Adding IsPiecePart condition in RepairOrderPart table
		...
		BEGIN
			...
			(
				SELECT 
					...
					--	CASE 
					--		WHEN ISNULL(SST.StockLineId,0) > 0 
					--			THEN SUM(SST.QtyOrder)
					--		ELSE SUM(SOP.QtyOrder)
					--	END,
					--	IUS.ShortName,
					--	IUC.ShortName,
					--	0,
