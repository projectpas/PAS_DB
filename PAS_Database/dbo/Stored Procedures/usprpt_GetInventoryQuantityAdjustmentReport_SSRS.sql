 ...
 ** --   --------         -------          --------------------------------            
	...
	5    24/July/2026     RAJESH GAMI		[PN-17350] - Removed obsolete Stockline.IsNonStock=0 filters (3) to allow Non-Stock items in Inventory Quantity Adjustment SSRS Report
**************************************************************/
