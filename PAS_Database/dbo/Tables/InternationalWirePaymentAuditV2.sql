CREATE TABLE [dbo].[InternationalWirePaymentAuditV2] (
    ...
    CONSTRAINT [PK_InternationalWirePaymentAuditV2] PRIMARY KEY CLUSTERED ([InternationalWirePaymentAuditId] ASC),
    CONSTRAINT [FK_InternationalWirePaymentAuditV2_InternationalWirePaymentV2] FOREIGN KEY ([InternationalWirePaymentId]) REFERENCES [dbo].[InternationalWirePaymentV2] ([InternationalWirePaymentId])
);
