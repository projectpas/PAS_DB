CREATE TABLE [dbo].[RepairOrderShippingAudit] (
    [AuditRepairOrderShippingId]       BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_RepairOrderShippingAudit] PRIMARY KEY CLUSTERED ([AuditRepairOrderShippingId] ASC),
    CONSTRAINT [FK_RepairOrderShippingAudit_RepairOrderShipping] FOREIGN KEY ([RepairOrderShippingId]) REFERENCES [dbo].[RepairOrderShipping] ([RepairOrderShippingId])
);
