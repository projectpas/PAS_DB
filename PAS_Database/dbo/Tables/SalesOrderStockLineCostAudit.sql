CREATE TABLE [dbo].[SalesOrderStockLineCostAudit] (
    [AuditSalesOrderStockLineCostId] BIGINT          IDENTITY (1, 1) NOT NULL,
    [SalesOrderStockLineCostId]      BIGINT          NOT NULL,
    ...
    CONSTRAINT [PK_SalesOrderStockLineCostAudit] PRIMARY KEY CLUSTERED ([AuditSalesOrderStockLineCostId] ASC)
);
