CREATE TABLE [dbo].[StocklineAudit] (
    ...
    [Adjustment]                          DECIMAL (18, 6) CONSTRAINT [DF_StocklineAudit_Adjustment] DEFAULT ((0)) NULL,
    [SalesOrderPartId]                    BIGINT          NULL,
    [FreightAdjustment]                   DECIMAL (18, 6) CONSTRAINT [DF_StocklineAudit_FreightAdjustment] DEFAULT ((0)) NULL,
    [TaxAdjustment]                       DECIMAL (18, 6) CONSTRAINT [DF_StocklineAudit_TaxAdjustment] DEFAULT ((0)) NULL,
