CREATE TABLE [dbo].[SubWorkOrderTaskDetailsAudit] (
    [SubWorkOrderTaskDetailsAuditId] BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_SubWorkOrderTaskDetailsAudit] PRIMARY KEY CLUSTERED ([SubWorkOrderTaskDetailsAuditId] ASC)
);
