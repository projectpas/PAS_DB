CREATE TABLE [dbo].[SuspenseAndUnAppliedPaymentMSDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_SuspenseAndUnAppliedPaymentMSDetails_CreatedDate] DEFAULT (getutcdate()) NOT NULL,
    [UpdatedBy]       VARCHAR (256) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_SuspenseAndUnAppliedPaymentMSDetails_UpdatedDate] DEFAULT (getutcdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF__SuspenseAndUnAppliedPaymentMSDetails__IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF__SuspenseAndUnAppliedPaymentMSDetails__IsDeleted] DEFAULT ((0)) NOT NULL,
    [LastMSLevel]     VARCHAR (256) NULL,
    [AllMSlevels]     VARCHAR (256) NULL,
    CONSTRAINT [PK_SuspenseAndUnAppliedPaymentMSDetails] PRIMARY KEY CLUSTERED ([MSDetailsId] ASC)
);
