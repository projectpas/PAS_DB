CREATE TABLE [dbo].[AssetInventory] (
    ...
    [CertificationDefaultCost]          DECIMAL (18, 6) CONSTRAINT [AssetInventory_CertificationDefaultCost] DEFAULT ((0)) NULL,
    ...
    [InspectionDefaultCost]             DECIMAL (18, 6) CONSTRAINT [AssetInventory_InspectionDefaultCost] DEFAULT ((0)) NULL,
    ...
    [VerificationDefaultCost]           DECIMAL (18, 6) CONSTRAINT [AssetInventory_VerificationDefaultCost] DEFAULT ((0)) NULL,
    [CalibrationDefaultCost]            DECIMAL (18, 6) CONSTRAINT [AssetInventory_CalibrationDefaultCost] DEFAULT ((0)) NULL,
    ...
    [RRQty]                             DECIMAL (18, 6) CONSTRAINT [DF__AssetInve__RRQty__741D5092] DEFAULT ((0)) NULL,
    [DepreciationMethodId]              BIGINT          NULL,
    [DepreciationMethodName]            VARCHAR (250)   NULL,
    [ResidualPercentageId]              BIGINT          NULL,
    [ResidualPercentage]                DECIMAL (18, 6) NULL,
