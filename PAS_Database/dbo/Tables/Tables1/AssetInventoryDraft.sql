CREATE TABLE [dbo].[AssetInventoryDraft] (
    ...
    [CertificationDefaultCost]          DECIMAL (18, 6) CONSTRAINT [AssetInventoryDraft_CertificationDefaultCost] DEFAULT ((0)) NULL,
    ...
    [InspectionDefaultCost]             DECIMAL (18, 6) CONSTRAINT [AssetInventoryDraft_InspectionDefaultCost] DEFAULT ((0)) NULL,
    ...
    [VerificationDefaultCost]           DECIMAL (18, 6) CONSTRAINT [AssetInventoryDraft_VerificationDefaultCost] DEFAULT ((0)) NULL,
    [CalibrationDefaultCost]            DECIMAL (18, 6) CONSTRAINT [AssetInventoryDraft_CalibrationDefaultCost] DEFAULT ((0)) NULL,
