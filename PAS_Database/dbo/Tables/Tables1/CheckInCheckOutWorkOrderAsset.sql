CREATE TABLE [dbo].[CheckInCheckOutWorkOrderAsset] (
    ...
    CONSTRAINT [FK_CheckInCheckOutWorkOrderAsset_AssetAvailableStatus] FOREIGN KEY ([InventoryStatusId]) REFERENCES [dbo].[AssetAvailableStatus] ([AssetAvailableStatusId]),
