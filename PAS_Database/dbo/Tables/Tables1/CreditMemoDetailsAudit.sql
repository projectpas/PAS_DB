CREATE TABLE [dbo].[CreditMemoDetailsAudit] (
    [CreditMemoDetailAuditId] BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [IsWorkOrder]             BIT             CONSTRAINT [DF_CreditMemoDetailsAudit_IsWorkOrder] DEFAULT ((0)) NULL,
    [MasterCompanyId]         INT             NOT NULL,
    [CreatedBy]               VARCHAR (256)   NOT NULL,
    [UpdatedBy]               VARCHAR (256)   NOT NULL,
    [CreatedDate]             DATETIME2 (7)   CONSTRAINT [DF_CreditMemoDetailsAudit_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]             DATETIME2 (7)   CONSTRAINT [DF_CreditMemoDetailsAudit_UpdatedDate] DEFAULT (getdate()) NOT NULL,
