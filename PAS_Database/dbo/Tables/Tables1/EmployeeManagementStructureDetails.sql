CREATE TABLE [dbo].[EmployeeManagementStructureDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_EmployeeManagementStructureDetails_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_EmployeeManagementStructureDetails_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_EmployeeManagementStructureDetails_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_EmployeeManagementStructureDetails_IsDeleted] DEFAULT ((0)) NOT NULL,
    [LastMSLevel]     VARCHAR (200) NULL,
    [AllMSlevels]     VARCHAR (MAX) NULL,
    CONSTRAINT [PK_EmployeeManagementStructureDetails] PRIMARY KEY CLUSTERED ([MSDetailsId] ASC)
);
