CREATE TABLE [dbo].[ExchangeSalesOrderCustomsInfoAudit] (
    ...
    CONSTRAINT [PK_ExchangeSalesOrderCustomsInfoAudit] PRIMARY KEY CLUSTERED ([AuditExchangeSalesOrderCustomsInfoId] ASC),
    CONSTRAINT [FK_ExchangeSalesOrderCustomsInfoAudit_ExchangeSalesOrderCustomsInfo] FOREIGN KEY ([ExchangeSalesOrderCustomsInfoId]) REFERENCES [dbo].[ExchangeSalesOrderCustomsInfo] ([ExchangeSalesOrderCustomsInfoId])
);
