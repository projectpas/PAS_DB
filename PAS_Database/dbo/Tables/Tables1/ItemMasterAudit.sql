CREATE TABLE [dbo].[ItemMasterAudit] (
    ...
    [ReorderPoint]                      DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_ReorderPoint_1] DEFAULT ((0)) NOT NULL,
    [ReorderQuantiy]                    DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_ReorderQuantiy_1] DEFAULT ((0)) NOT NULL,
    [MinimumOrderQuantity]              DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_MinimumOrderQuantity_1] DEFAULT ((0)) NOT NULL,
    ...
    [mfgHours]                          DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_mfgHours_1] DEFAULT ((0)) NULL,
    [IsPma]                             BIT             CONSTRAINT [DF_ItemMasterAudit_IsPma_1] DEFAULT ((0)) NOT NULL,
    [turnTimeMfg]                       DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_turnTimeMfg_1] DEFAULT ((0)) NULL,
    [turnTimeBenchTest]                 DECIMAL (18, 6) CONSTRAINT [DF_ItemMasterAudit_turnTimeBenchTest_1] DEFAULT ((0)) NULL,
