...
CREATE NONCLUSTERED INDEX [IX_NonPOInvoiceHeader_MasterCompanyId_IsDeleted_IsActive_Perf]
    ...
    INCLUDE([VendorId], [VendorName], [VendorCode], [PaymentTermsId], [StatusId], [ManagementStructureId], [CreatedBy], [UpdatedBy], [CreatedDate], [UpdatedDate], [InvoiceDate], [DueDate], [PaymentMethodId], [NPONumber], [InvoiceNumber], [ControlNumber], [IsUpdated])
