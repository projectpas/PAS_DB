CREATE TABLE [dbo].[NonStockInventoryAudit] (
    [NonStockInventoryAuditId]     BIGINT          IDENTITY (1, 1) NOT NULL,
    [NonStockInventoryId]          BIGINT          NOT NULL,
    ...
    [CreatedDate]                  DATETIME2 (7)   CONSTRAINT [DF_NonStockInventoryAudit_CreatedDate] DEFAULT (getdate()) NOT NULL,
