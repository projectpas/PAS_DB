CREATE TABLE [dbo].[NonStockInventoryDraftAudit] (
    [NonStockInventoryDraftAuditId]      BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    [CreatedDate]                        DATETIME2 (7)   CONSTRAINT [DF_NonStockInventoryDraftAudit_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]                        DATETIME2 (7)   CONSTRAINT [DF_NonStockInventoryDraftAudit_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]                           BIT             CONSTRAINT [DF_NonStockInventoryDraftAudit_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]                          BIT             CONSTRAINT [DF_NonStockInventoryDraftAudit_IsDeleted] DEFAULT ((0)) NOT NULL,
    [ShippingReferenceNumberNotProvided] BIT             NULL,
    [TimeLifeDetailsNotProvided]         BIT             NULL,
    [SerialNumberNotProvided]            BIT             NULL,
    CONSTRAINT [PK_NonStockInventoryDraftAudit] PRIMARY KEY CLUSTERED ([NonStockInventoryDraftAuditId] ASC)
);
