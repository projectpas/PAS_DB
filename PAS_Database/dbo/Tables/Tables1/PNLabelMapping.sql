CREATE TABLE [dbo].[PNLabelMapping] (
    ...
    [FieldWidth]         DECIMAL (5, 2) NULL,
    [FieldHeight]        DECIMAL (5, 2) NULL,
    ...
    [FieldDPI]           DECIMAL (5, 2) NULL,
    [MarginLeft]         DECIMAL (5, 2) NULL,
    [MarginRight]        DECIMAL (5, 2) NULL,
    [MarginTop]          DECIMAL (5, 2) NULL,
    [MarginBottom]       DECIMAL (5, 2) NULL,
