CREATE TABLE [dbo].[PurchaseOrderManagementStructureDetails] (
    ...
    [CreatedDate]     DATETIME2 (7) CONSTRAINT [DF_PurchaseOrderManagementStructureDetails_CreatedDate] DEFAULT (getdate()) NOT NULL,
    [UpdatedDate]     DATETIME2 (7) CONSTRAINT [DF_PurchaseOrderManagementStructureDetails_UpdatedDate] DEFAULT (getdate()) NOT NULL,
    [IsActive]        BIT           CONSTRAINT [DF_PurchaseOrderManagementStructureDetails_IsActive] DEFAULT ((1)) NOT NULL,
    [IsDeleted]       BIT           CONSTRAINT [DF_PurchaseOrderManagementStructureDetails_IsDeleted] DEFAULT ((0)) NOT NULL,
    [LastMSLevel]     VARCHAR (200) NULL,
    [AllMSlevels]     VARCHAR (MAX) NULL,
    CONSTRAINT [PK_PurchaseOrderManagementStructureDetails] PRIMARY KEY CLUSTERED ([MSDetailsId] ASC)
);
...
AS
BEGIN
	INSERT INTO PurchaseOrderManagementStructureDetailsAudit
...
END
GO
CREATE NONCLUSTERED INDEX [IX_POMSD_Module_Reference]
