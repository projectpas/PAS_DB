CREATE TABLE [dbo].[SalesOrderQuoteApproval] (
    ...
    CONSTRAINT [FK_SalesOrderQuoteApproval_SalesOrderQuotePartV1] FOREIGN KEY ([SalesOrderQuotePartId]) REFERENCES [dbo].[SalesOrderQuotePartV1] ([SalesOrderQuotePartId])
);
