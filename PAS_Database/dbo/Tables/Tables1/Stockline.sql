CREATE TABLE [dbo].[Stockline] (
    ...
    [PurchaseOrderUnitCost]               DECIMAL (18, 6) CONSTRAINT [DF_Stockline_PurchaseOrderUnitCost] DEFAULT ((0)) NULL,
    [InventoryUnitCost]                   DECIMAL (18, 6) CONSTRAINT [DF_Stockline_InventoryUnitCost] DEFAULT ((0)) NULL,
    [RepairOrderId]                       BIGINT          NULL,
    [RepairOrderUnitCost]                 DECIMAL (18, 6) CONSTRAINT [DF_Stockline_RepairOrderUnitCost] DEFAULT ((0)) NULL,
    [ReceivedDate]                        DATETIME2 (7)   NULL,
    [ReceiverNumber]                      VARCHAR (50)    NULL,
    [ReconciliationNumber]                VARCHAR (50)    NULL,
    [UnitSalesPrice]                      DECIMAL (18, 6) CONSTRAINT [DF_Stockline_UnitSalesPrice] DEFAULT ((0)) NULL,
    [CoreUnitCost]                        DECIMAL (18, 6) CONSTRAINT [DF_Stockline_CoreUnitCost] DEFAULT ((0)) NULL,
    ...
    [PurchaseOrderExtendedCost]           DECIMAL (18, 6) CONSTRAINT [DF__Stockline__Purch__53E4BFD3] DEFAULT ((0)) NULL,
    ...
    [QuantityRejected]                    DECIMAL (18, 6) CONSTRAINT [DF__Stockline__Quant__14BE5EF7] DEFAULT ((0)) NULL,
    ...
    [WorkOrderExtendedCost]               DECIMAL (18, 6) NULL,
    ...
    [LotCost]                             DECIMAL (18, 6) CONSTRAINT [DF_Stockline_LotCost] DEFAULT ((0)) NULL,
    ...
    [Adjustment]                          DECIMAL (18, 6) CONSTRAINT [DF_Stockline_Adjustment] DEFAULT ((0)) NULL,
    [SalesOrderPartId]                    BIGINT          NULL,
    [FreightAdjustment]                   DECIMAL (18, 6) CONSTRAINT [DF_Stockline_FreightAdjustment] DEFAULT ((0)) NULL,
    [TaxAdjustment]                       DECIMAL (18, 6) CONSTRAINT [DF_Stockline_TaxAdjustment] DEFAULT ((0)) NULL,
...
CREATE     TRIGGER [dbo].[trg_Audit_dbo_Stockline]
        ...
        BEGIN
            SET NOCOUNT ON;
            ;WITH
            d AS (SELECT d.[StockLineId],d.[PartNumber],d.[PNDescription],d.[Manufacturer],d.[RevicedPNNumber],d.[ItemGroup],d.[UnitOfMeasure],d.[Condition],d.[Location],d.[QuantityOnHand],d.[QtyReserved],d.[QuantityAvailable],d.[QuantityAdjustment],d.[UnitCost],d.[SerialNumber],d.[IsCustomerStock],d.[IsRepairManagement],d.[IsStkTimeLife],d.[IsDocument],d.[StockLineNumber],d.[ControlNumber],d.[ReceivedDate],d.[ExpirationDate],d.[PurchaseOrderNumber],d.[RepairOrderNumber],d.[ReceiverNumber],d.[TraceableTo],d.[ObtainFrom],d.[TagType],d.[TaggedBy],d.[TagDate],d.[PartCertificationNumber],d.[CertifiedBy],d.[CertifiedDate],d.[UpdatedBy],d.[UpdatedDate],d.[WorkOrderNumber],d.[LotNumber],d.[CustomerName],d.[BatchNumber],d.[CreatedBy],d.[CreatedDate],d.[IsActive],d.[IsDeleted] FROM deleted d),
            i AS (SELECT i.[StockLineId],i.[PartNumber],i.[PNDescription],i.[Manufacturer],i.[RevicedPNNumber],i.[ItemGroup],i.[UnitOfMeasure],i.[Condition],i.[Location],i.[QuantityOnHand],i.[QtyReserved],i.[QuantityAvailable],i.[QuantityAdjustment],i.[UnitCost],i.[SerialNumber],i.[IsCustomerStock],i.[IsRepairManagement],i.[IsStkTimeLife],i.[IsDocument],i.[StockLineNumber],i.[ControlNumber],i.[ReceivedDate],i.[ExpirationDate],i.[PurchaseOrderNumber],i.[RepairOrderNumber],i.[ReceiverNumber],i.[TraceableTo],i.[ObtainFrom],i.[TagType],i.[TaggedBy],i.[TagDate],i.[PartCertificationNumber],i.[CertifiedBy],i.[CertifiedDate],i.[UpdatedBy],i.[UpdatedDate],i.[WorkOrderNumber],i.[LotNumber],i.[CustomerName],i.[BatchNumber],i.[CreatedBy],i.[CreatedDate],i.[IsActive],i.[IsDeleted] FROM inserted i),
