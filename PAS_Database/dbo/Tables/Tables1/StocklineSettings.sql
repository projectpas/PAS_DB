CREATE TABLE [dbo].[StocklineSettings] (
    ...
    [PartsBaseSiteId]      BIGINT        NULL,
    [PartsBaseSite]        VARCHAR (100) NULL,
    [PartsBaseWarehouseId] BIGINT        NULL,
    [PartsBaseWarehouse]   VARCHAR (100) NULL,
    [PartsBaseLocationId]  BIGINT        NULL,
    [PartsBaseLocation]    VARCHAR (100) NULL,
    [PartsBaseShelfId]     BIGINT        NULL,
    [PartsBaseShelf]       VARCHAR (100) NULL,
    [PartsBaseBinId]       BIGINT        NULL,
    [PartsBaseBin]         VARCHAR (100) NULL,
