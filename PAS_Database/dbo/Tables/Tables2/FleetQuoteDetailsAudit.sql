/*************************************************************           
 ** File:   [FleetQuoteDetailsAudit.sql]           
 ** Author:   SUMIT KUMAR
 ** Description: This Table is used to store Audit history for Fleet Quote Details
 ** Date:   09/08/2026        
 **************************************************************           
  ** Change History           
 **************************************************************           
 ...
 **************************************************************/
CREATE TABLE [dbo].[FleetQuoteDetailsAudit] (
    [AuditFleetQuoteDetailsId]      BIGINT          IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_FleetQuoteDetailsAudit] PRIMARY KEY CLUSTERED ([AuditFleetQuoteDetailsId] ASC)
);
