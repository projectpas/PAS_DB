CREATE TABLE [dbo].[SubWorkOrderMPNCostDetailAudit] (
    [SubWOMPNCostDetailsAuditId] BIGINT          IDENTITY (1, 1) NOT NULL,
    [SubWOMPNCostDetailsId]      BIGINT          NOT NULL,
    ...
    CONSTRAINT [PK_SubWorkOrderMPNCostDetailAudit] PRIMARY KEY CLUSTERED ([SubWOMPNCostDetailsAuditId] ASC)
);
