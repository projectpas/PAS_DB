CREATE TABLE [dbo].[SubWorkOrderMaterialsKit] (
    ...
    [Quantity]                          DECIMAL (18, 6) CONSTRAINT [DF__SubWorkOr__Quant__3D9984B4] DEFAULT ((0)) NULL,
    [UnitOfMeasureId]                   BIGINT          NOT NULL,
    [UnitCost]                          DECIMAL (18, 6) CONSTRAINT [DF__SubWorkOr__UnitC__6D711E5A] DEFAULT ((0)) NULL,
    [ExtendedCost]                      DECIMAL (18, 6) CONSTRAINT [DF__SubWorkOr__Exten__6E654293] DEFAULT ((0)) NULL,
    ...
    [Bin]                               VARCHAR (50)    NULL,
    [TotalStocklineQtyReq]              DECIMAL (18, 6) CONSTRAINT [DF__SubWorkOr__Total__3E8DA8ED] DEFAULT ((0)) NULL,
    [POId]                              BIGINT          NULL,
