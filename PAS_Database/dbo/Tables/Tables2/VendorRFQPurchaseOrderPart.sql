CREATE TABLE [dbo].[VendorRFQPurchaseOrderPart] (
    ...
    [QuantityOrdered]          DECIMAL (18, 6) CONSTRAINT [VendorRFQPurchaseOrderPart_QuantityOrdered] DEFAULT ((0)) NOT NULL,
    [UnitCost]                 DECIMAL (18, 6) CONSTRAINT [VendorRFQPurchaseOrderPart_UnitCost] DEFAULT ((0)) NOT NULL,
    [ExtendedCost]             DECIMAL (18, 6) CONSTRAINT [VendorRFQPurchaseOrderPart_ExtendedCost] DEFAULT ((0)) NOT NULL,
