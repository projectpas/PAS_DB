CREATE TABLE [dbo].[VendorRFQPurchaseOrderPartAudit] (
    ...
    [QuantityOrdered]              DECIMAL (18, 6) CONSTRAINT [DF_VendorRFQPurchaseOrderPartAudit_QuantityOrdered] DEFAULT ((0)) NULL,
    [UnitCost]                     DECIMAL (18, 6) CONSTRAINT [DF_VendorRFQPurchaseOrderPartAudit_UnitCost] DEFAULT ((0)) NULL,
    [ExtendedCost]                 DECIMAL (18, 6) CONSTRAINT [DF_VendorRFQPurchaseOrderPartAudit_ExtendedCost] DEFAULT ((0)) NULL,
