CREATE TABLE [dbo].[WorkOrderBillingInvoicing] (
    ...
    [TotalWorkOrderValue]                DECIMAL (20, 2) NULL,
    [Material]                           BIT             NULL,
    [MaterialValue]                      DECIMAL (20, 2) NULL,
    [LaborOverHead]                      BIT             NULL,
    [LaborOverHeadValue]                 DECIMAL (20, 2) NULL,
    [MiscCharges]                        BIT             NULL,
    [MiscChargesValue]                   DECIMAL (20, 2) NULL,
    [ProForma]                           BIT             NULL,
    ...
    CONSTRAINT [FK_WorkOrderBillingInvoicing_Condition] FOREIGN KEY ([ConditionId]) REFERENCES [dbo].[Condition] ([ConditionId]),
