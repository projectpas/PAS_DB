CREATE TABLE [dbo].[WorkOrderCostDetails] (
    ...
    [Revenue]                DECIMAL (28, 6) NULL,
    [PartsCost]              DECIMAL (28, 6) NULL,
    [PartsRevPercentage]     DECIMAL (28, 6) NULL,
    [LaborCost]              DECIMAL (28, 6) NULL,
    [LaborRevPercentage]     DECIMAL (28, 6) NULL,
    [OverHeadCost]           DECIMAL (28, 6) NULL,
    [OverHeadPercentage]     DECIMAL (28, 6) NULL,
    [OtherCost]              DECIMAL (28, 6) NULL,
    [DirectCost]             DECIMAL (28, 6) NULL,
    [DirectCostPercentage]   DECIMAL (28, 6) NULL,
    [Margin]                 DECIMAL (28, 6) NULL,
    [MarginPercentage]       DECIMAL (28, 6) NULL,
    [ChargesCost]            DECIMAL (28, 6) NULL,
    [ExclusionCost]          DECIMAL (28, 6) NULL,
    [FreightCost]            DECIMAL (28, 6) NULL,
    [TotalCost]              DECIMAL (28, 6) NULL,
    [ActualRevenue]          DECIMAL (28, 6) NULL,
    [ActualMargin]           DECIMAL (28, 6) NULL,
    [ActualMarginPercentage] DECIMAL (28, 6) NULL,
