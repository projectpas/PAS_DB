CREATE TABLE [dbo].[WorkOrderMaterials] (
    ...
    [Quantity]                   DECIMAL (18, 6) CONSTRAINT [DF__WorkOrder__Quant__453AA67C] DEFAULT ((0)) NULL,
    [UnitOfMeasureId]            BIGINT          NOT NULL,
    [UnitCost]                   DECIMAL (18, 6) DEFAULT ((0)) NOT NULL,
    [ExtendedCost]               DECIMAL (18, 6) DEFAULT ((0)) NOT NULL,
    ...
    [TotalStocklineQtyReq]       DECIMAL (18, 6) CONSTRAINT [DF__WorkOrder__Total__462ECAB5] DEFAULT ((0)) NULL,
    [QtyOnOrder]                 DECIMAL (18, 6) CONSTRAINT [DF__WorkOrder__QtyOn__4722EEEE] DEFAULT ((0)) NULL,
    [QtyOnBkOrder]               DECIMAL (18, 6) CONSTRAINT [DF__WorkOrder__QtyOn__48171327] DEFAULT ((0)) NULL,
    [POId]                       BIGINT          NULL,
