CREATE TABLE [dbo].[WorkOrderWorkPerformedAudit] (
    [WorkOrderWorkPerformedAuditId] BIGINT         IDENTITY (1, 1) NOT NULL,
    [WorkOrderWorkPerformedId]      BIGINT         NOT NULL,
    ...
    CONSTRAINT [PK_WorkOrderWorkPerformedAudit] PRIMARY KEY CLUSTERED ([WorkOrderWorkPerformedAuditId] ASC)
);
