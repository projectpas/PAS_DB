CREATE TABLE [dbo].[VendorRFQROChargesAudit] (
    [VendorRFQROChargesAuditId] BIGINT          IDENTITY (1, 1) NOT NULL,
    [VendorRFQROChargesId]      BIGINT          NOT NULL,
    ...
    [UOMId]                     BIGINT          NULL,
    CONSTRAINT [PK_VendorRFQROChargesAudit] PRIMARY KEY CLUSTERED ([VendorRFQROChargesAuditId] ASC)
);
