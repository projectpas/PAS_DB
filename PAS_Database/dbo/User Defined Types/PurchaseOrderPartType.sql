CREATE TYPE [dbo].[PurchaseOrderPartType] AS TABLE (
    ...
    [QuantityBackOrdered]            DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [QuantityRejected]               DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [VendorListPrice]                DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [DiscountPercent]                BIGINT          DEFAULT ((0)) NULL,
    [DiscountPerUnit]                DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [DiscountAmount]                 DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [UnitCost]                       DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [ExtendedCost]                   DECIMAL (18, 6) DEFAULT ((0)) NULL,
    [FunctionalCurrencyId]           INT             NULL,
    [FunctionalCurrency]             NVARCHAR (MAX)  NULL,
    [ForeignExchangeRate]            DECIMAL (18, 6) DEFAULT ((0)) NULL,
    ...
    [DiscountPercentValue]           DECIMAL (18, 6) DEFAULT ((0)) NULL,
