...
AS
SELECT        dbo.DefaultMessage.DefaultMessageId, dbo.DefaultMessage.Description, dbo.Module.ModuleDisplayName as ModuleName, dbo.DefaultMessage.Memo, dbo.DefaultMessage.MasterCompanyId, dbo.DefaultMessage.CreatedBy, dbo.DefaultMessage.UpdatedBy, 
