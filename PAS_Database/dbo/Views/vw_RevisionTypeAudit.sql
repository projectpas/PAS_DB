...
AS
	...
	,RTA.CreatedDate AS 'Created On', RTA.UpdatedDate AS 'Updated On', RTA.IsActive AS 'Active ?', RTA.IsDeleted AS 'Deleted ?',RTA.MasterCompanyId, RTA.CreatedBy as 'Created By', RTA.UpdatedBy AS 'Updated By'
