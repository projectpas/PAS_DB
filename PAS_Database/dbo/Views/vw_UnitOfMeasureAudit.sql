...
AS
	SELECT ipor.UnitOfMeasureAuditId  AS PkID, ipor.UnitOfMeasureId AS ID	,ipor.Description ,ipor.ShortName , ipor.StandardName , ipor.SequenceNo, ipor.UOMFamilyTypeName AS [Family Type]
