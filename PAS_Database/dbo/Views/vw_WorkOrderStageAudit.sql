...
AS
	...
	WS.Status AS 'Status', WSA.CreatedDate, WSA.UpdatedDate, WSA.IsActive, WSA.CreatedBy, WSA.UpdatedBy, WSA.IsDeleted,WSA.WorkableBacklog ,WSA.IncludeInTAT,WSA.QuoteDays,WSA.ShippedDays
