...
AS
	...
	,WPA.IsActive AS 'Active ?', WPA.IsDeleted AS 'Deleted ?', WPA.CreatedBy as 'Created By', WPA.UpdatedBy AS 'Updated By', WPA.CreatedDate AS 'Created On', WPA.UpdatedDate AS 'Updated On', WPA.MasterCompanyId
