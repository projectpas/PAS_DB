...
FROM            dbo.Address 
INNER JOIN dbo.Site ON dbo.Address.AddressId = dbo.Site.AddressId 
INNER JOIN dbo.Location 
INNER JOIN dbo.Warehouse ON dbo.Location.WarehouseId = dbo.Warehouse.WarehouseId ON dbo.Site.SiteId = dbo.Warehouse.SiteId INNER JOIN
